...
// Type: FSM.FRMAddPostcodeManager
...
namespace FSM
{
  public class FRMAddPostcodeManager : FRMBaseForm, IForm
  {
    private IContainer components;
    private int _PostcodeID;
    private DataView _dvEngineers;

    public FRMAddPostcodeManager()
    {
    ...
    private void InitializeComponent()
    {
      ...
      this.dgEngineers.Location = new System.Drawing.Point(6, 20);
      ...
      this.ClientSize = new Size(352, 481);
      ...
      this.Name = nameof (FRMAddPostcodeManager);
