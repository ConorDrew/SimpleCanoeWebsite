...
// Type: FSM.FRMCustomerScheduleOfRate
...
namespace FSM
{
  public class FRMCustomerScheduleOfRate : FRMBaseForm, IForm
  {
    ...
    public FRMCustomerScheduleOfRate()
    {
      this.Load += new EventHandler(this.FRMCustomerScheduleOfRate_Load);
      this._ID = 0;
      this.InitializeComponent();
      this.TheLoadedControl = (IUserControl) new UCCustomerScheduleOfRate(Enums.TableNames.tblCustomer, 0, false);
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = nameof (FRMCustomerScheduleOfRate);
    ...
    void IForm.LoadMe(object sender, EventArgs e)
    {
      ...
      ((UCCustomerScheduleOfRate) this.TheLoadedControl).SetupRatesDataGrid();
      ((UCCustomerScheduleOfRate) this.TheLoadedControl).Populate(0);
    }
    ...
    public int ID
    {
      ...
      {
        this._ID = value;
        this.Text = "Customer Schedule Of Rates";
      }
    }
