...
namespace FSM
{
  public class FRMProductSupplier : FRMBaseForm, IForm
  {
    ...
    {
      this.Load += new EventHandler(this.FRMProductSupplier_Load);
      this._ID = 0;
      this.InitializeComponent();
      this.TheLoadedControl = (IUserControl) new UCProductSupplier();
    ...
    private void InitializeComponent()
    {
      ...
      this.btnSave.Location = new System.Drawing.Point(8, 159);
      this.btnSave.Name = "btnSave";
      this.btnSave.Size = new Size(56, 25);
      this.btnSave.TabIndex = 2;
      this.btnSave.Text = "Save";
      this.btnClose.Anchor = AnchorStyles.Bottom | AnchorStyles.Left;
      this.btnClose.Location = new System.Drawing.Point(72, 159);
      ...
      this.pnlMain.Size = new Size(586, 120);
      this.pnlMain.TabIndex = 1;
      this.AutoScaleBaseSize = new Size(6, 14);
      this.ClientSize = new Size(603, 197);
      this.Controls.Add((Control) this.btnClose);
      this.Controls.Add((Control) this.btnSave);
      this.Controls.Add((Control) this.pnlMain);
      this.MaximizeBox = false;
      this.MaximumSize = new Size(611, 231);
      this.MinimizeBox = false;
      this.MinimumSize = new Size(611, 231);
      this.Name = nameof (FRMProductSupplier);
      this.Text = "Product Supplier : ID {0}";
    ...
    void IForm.LoadMe(object sender, EventArgs e)
    {
      ...
      ((UCProductSupplier) this.LoadedControl).ProductID = Helper.MakeIntegerValid(RuntimeHelpers.GetObjectValue(this.get_GetParameter(1)));
      ((UCProductSupplier) this.LoadedControl).CurrentProductSupplier = App.DB.ProductSupplier.ProductSupplier_Get(this.ID);
    ...
    {
      this.ID = newID;
      ((UCProduct) this.get_GetParameter(2)).PopulateSuppliers();
    }
    ...
    public int ID
    {
      ...
      set
      {
        ...
        if (this.ID == 0)
        {
          ...
          this.Text = "Product Supplier : Adding New...";
        }
        else
        {
          this.PageState = Enums.FormState.Update;
          this.Text = "Product Supplier : ID " + Conversions.ToString(this.ID);
        }
      }
    }
