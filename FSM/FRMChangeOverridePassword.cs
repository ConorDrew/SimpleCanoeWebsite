...
// Type: FSM.FRMChangeOverridePassword
...
namespace FSM
{
  public class FRMChangeOverridePassword : FRMBaseForm, IForm
  {
    ...
    public FRMChangeOverridePassword()
    {
    ...
    private void InitializeComponent()
    {
      ...
      this.ClientSize = new Size(400, 238);
      ...
      this.Name = nameof (FRMChangeOverridePassword);
    ...
    private void btnUpdate_Click(object sender, EventArgs e)
    {
      try
      {
        ...
        if ((uint) Operators.CompareString(Helper.HashPassword(this.txtPassword.Text.Trim()), App.DB.Manager.Get().OverridePassword, false) > 0U)
        {
        ...
        if (flag)
        {
          App.DB.Manager.UpdateOverridePassword(this.txtNewPassword.Text.Trim());
          int num2 = (int) App.ShowMessage("Override Password Updated", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
          this.txtPassword.Text = "";
          this.txtNewPassword.Text = "";
          this.txtConfirm.Text = "";
        }
