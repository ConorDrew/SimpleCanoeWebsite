...
// Type: FSM.FSMDataSetTableAdapters.EngineerVisitScheduleOfRatesCharge_Get_For_EngineerVisitIDTableAdapter
...
namespace FSM.FSMDataSetTableAdapters
{
  ...
  public class EngineerVisitScheduleOfRatesCharge_Get_For_EngineerVisitIDTableAdapter : Component
  {
    ...
    public EngineerVisitScheduleOfRatesCharge_Get_For_EngineerVisitIDTableAdapter()
    {
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "EngineerVisitScheduleOfRatesCharge_Get_For_EngineerVisitID",
        ColumnMappings = {
          {
            "tick",
            "tick"
          ...
          {
            "EngineerVisitScheduleOfRateChargesID",
            "EngineerVisitScheduleOfRateChargesID"
          },
          {
            "JobItemID",
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "dbo.EngineerVisitScheduleOfRatesCharge_Get_For_EngineerVisitID";
    ...
    public virtual int Fill(
      FSMDataSet.EngineerVisitScheduleOfRatesCharge_Get_For_EngineerVisitIDDataTable dataTable,
      int? EngineerVisitID)
    {
    ...
    public virtual FSMDataSet.EngineerVisitScheduleOfRatesCharge_Get_For_EngineerVisitIDDataTable GetData(
      int? EngineerVisitID)
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      this.Adapter.SelectCommand.Parameters[1].Value = !EngineerVisitID.HasValue ? (object) DBNull.Value : (object) EngineerVisitID.Value;
      FSMDataSet.EngineerVisitScheduleOfRatesCharge_Get_For_EngineerVisitIDDataTable visitIdDataTable = new FSMDataSet.EngineerVisitScheduleOfRatesCharge_Get_For_EngineerVisitIDDataTable();
