...
// Type: FSM.FSMDataSetTableAdapters.EngineerVisitUnitsUsed_Get_For_EngineerVisitIDTableAdapter
...
namespace FSM.FSMDataSetTableAdapters
{
  ...
  public class EngineerVisitUnitsUsed_Get_For_EngineerVisitIDTableAdapter : Component
  {
    ...
    public EngineerVisitUnitsUsed_Get_For_EngineerVisitIDTableAdapter()
    {
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "EngineerVisitUnitsUsed_Get_For_EngineerVisitID",
        ColumnMappings = {
          {
            "JobItemID",
            "JobItemID"
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "dbo.EngineerVisitUnitsUsed_Get_For_EngineerVisitID";
    ...
    public virtual int Fill(
      FSMDataSet.EngineerVisitUnitsUsed_Get_For_EngineerVisitIDDataTable dataTable,
      int? EngineerVisitID)
    {
    ...
    public virtual FSMDataSet.EngineerVisitUnitsUsed_Get_For_EngineerVisitIDDataTable GetData(
      int? EngineerVisitID)
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      this.Adapter.SelectCommand.Parameters[1].Value = !EngineerVisitID.HasValue ? (object) DBNull.Value : (object) EngineerVisitID.Value;
      FSMDataSet.EngineerVisitUnitsUsed_Get_For_EngineerVisitIDDataTable visitIdDataTable = new FSMDataSet.EngineerVisitUnitsUsed_Get_For_EngineerVisitIDDataTable();
