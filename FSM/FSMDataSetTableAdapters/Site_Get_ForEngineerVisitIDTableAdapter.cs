...
// Type: FSM.FSMDataSetTableAdapters.Site_Get_ForEngineerVisitIDTableAdapter
...
namespace FSM.FSMDataSetTableAdapters
{
  ...
  public class Site_Get_ForEngineerVisitIDTableAdapter : Component
  {
    ...
    public Site_Get_ForEngineerVisitIDTableAdapter()
    {
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "Site_Get_ForEngineerVisitID",
        ColumnMappings = {
          {
            "SiteID",
            "SiteID"
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "dbo.Site_Get_ForEngineerVisitID";
    ...
    public virtual int Fill(
      FSMDataSet.Site_Get_ForEngineerVisitIDDataTable dataTable,
      int? EngineerVisitID)
    {
    ...
    public virtual FSMDataSet.Site_Get_ForEngineerVisitIDDataTable GetData(
      int? EngineerVisitID)
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      this.Adapter.SelectCommand.Parameters[1].Value = !EngineerVisitID.HasValue ? (object) DBNull.Value : (object) EngineerVisitID.Value;
      FSMDataSet.Site_Get_ForEngineerVisitIDDataTable visitIdDataTable = new FSMDataSet.Site_Get_ForEngineerVisitIDDataTable();
