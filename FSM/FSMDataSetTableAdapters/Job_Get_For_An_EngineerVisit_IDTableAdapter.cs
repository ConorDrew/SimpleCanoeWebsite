...
// Type: FSM.FSMDataSetTableAdapters.Job_Get_For_An_EngineerVisit_IDTableAdapter
...
namespace FSM.FSMDataSetTableAdapters
{
  ...
  public class Job_Get_For_An_EngineerVisit_IDTableAdapter : Component
  {
    ...
    public Job_Get_For_An_EngineerVisit_IDTableAdapter()
    {
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "Job_Get_For_An_EngineerVisit_ID",
        ColumnMappings = {
          {
            "JobID",
            "JobID"
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "dbo.Job_Get_For_An_EngineerVisit_ID";
    ...
    public virtual int Fill(
      FSMDataSet.Job_Get_For_An_EngineerVisit_IDDataTable dataTable,
      int? engineerVisitID)
    {
    ...
    public virtual FSMDataSet.Job_Get_For_An_EngineerVisit_IDDataTable GetData(
      int? engineerVisitID)
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      this.Adapter.SelectCommand.Parameters[1].Value = !engineerVisitID.HasValue ? (object) DBNull.Value : (object) engineerVisitID.Value;
      FSMDataSet.Job_Get_For_An_EngineerVisit_IDDataTable visitIdDataTable = new FSMDataSet.Job_Get_For_An_EngineerVisit_IDDataTable();
