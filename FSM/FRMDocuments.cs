...
namespace FSM
{
  public class FRMDocuments : FRMBaseForm, IForm
  {
    ...
    public FRMDocuments()
    {
      this.Load += new EventHandler(this.FRMDocuments_Load);
      this._ID = 0;
      this.InitializeComponent();
      this.TheLoadedControl = (IUserControl) new UCDocuments();
    ...
    private void InitializeComponent()
    {
      ...
      this.btnSave.Location = new System.Drawing.Point(8, 533);
      this.btnSave.Name = "btnSave";
      this.btnSave.Size = new Size(56, 25);
      this.btnSave.TabIndex = 2;
      this.btnSave.Text = "Save";
      this.btnClose.Anchor = AnchorStyles.Bottom | AnchorStyles.Left;
      this.btnClose.Location = new System.Drawing.Point(72, 533);
      ...
      this.pnlMain.Size = new Size(640, 493);
      this.pnlMain.TabIndex = 1;
      this.AutoScaleBaseSize = new Size(6, 14);
      this.ClientSize = new Size(648, 571);
      this.Controls.Add((Control) this.btnClose);
      this.Controls.Add((Control) this.btnSave);
      this.Controls.Add((Control) this.pnlMain);
      this.MaximizeBox = false;
      this.MinimizeBox = false;
      this.MinimumSize = new Size(656, 605);
      this.Name = nameof (FRMDocuments);
      this.Text = "Document : ID {0}";
    ...
    {
      ((UCDocuments) this.LoadedControl).EntityToLinkTo = (Enums.TableNames) Conversions.ToInteger(this.get_GetParameter(0));
      ((UCDocuments) this.LoadedControl).IDToLinkTo = Helper.MakeIntegerValid(RuntimeHelpers.GetObjectValue(this.get_GetParameter(1)));
      this.ID = Helper.MakeIntegerValid(RuntimeHelpers.GetObjectValue(this.get_GetParameter(2)));
      ((UCDocuments) this.LoadedControl).CurrentDocuments = App.DB.Documents.Documents_Get(this.ID);
    ...
    public void ResetMe(int newID)
    {
      ...
      try
      {
        ((UCDocumentsList) this.get_GetParameter(3)).IDToLinkTo = Helper.MakeIntegerValid(RuntimeHelpers.GetObjectValue(this.get_GetParameter(1)));
      }
      catch (Exception ex)
      {
    ...
    public int ID
    {
      ...
      set
      {
        ...
        if (this.ID == 0)
        {
          ...
          this.Text = "Document : Adding New...";
        }
        else
        {
          this.PageState = Enums.FormState.Update;
          this.Text = "Document : ID " + Conversions.ToString(this.ID);
        }
      }
    }
