      ...
      switch (App.TheSystem.DataBaseServerType)
      {
        case Enums.DatabaseSystems.Microsoft_SQL_Server:
          if (((SqlCommand) this.Command).Parameters.Count > 0)
          {
            ...
            try
            {
              enumerator = ((SqlCommand) this.Command).Parameters.GetEnumerator();
...
label_11:
    ...
    {
      object obj2;
      using (object Instance1 = (object) new SqlConnection(App.TheSystem.Configuration.ConnectionString))
      {
        using (object Instance2 = (object) new SqlCommand(spName, (SqlConnection) Instance1))
        {
          NewLateBinding.LateSetComplex(Instance2, (System.Type) null, "CommandType", new object[1]
          {
            (object) CommandType.StoredProcedure
          }, (string[]) null, (System.Type[]) null, false, true);
          if (parameters != null)
          {
            object[] objArray;
            bool[] flagArray;
            object obj = NewLateBinding.LateCall(NewLateBinding.LateGet(Instance2, (System.Type) null, "Parameters", new object[0], (string[]) null, (System.Type[]) null, (bool[]) null), (System.Type) null, "AddRange", objArray = new object[1]
            {
              (object) parameters
            }, (string[]) null, (System.Type[]) null, flagArray = new bool[1]
            {
            ...
            if (flagArray[0])
              parameters = (SqlParameter[]) Conversions.ChangeType(RuntimeHelpers.GetObjectValue(objArray[0]), typeof (SqlParameter[]));
          }
          object Instance3 = NewLateBinding.LateGet(NewLateBinding.LateGet(NewLateBinding.LateGet(Instance1, (System.Type) null, "OpenAsync", new object[0], (string[]) null, (System.Type[]) null, (bool[]) null), (System.Type) null, "ConfigureAwait", new object[1]
          {
            (object) false
          }, (string[]) null, (System.Type[]) null, (bool[]) null), (System.Type) null, "GetAwaiter", new object[0], (string[]) null, (System.Type[]) null, (bool[]) null);
          object obj1;
          int num;
          if (!Conversions.ToBoolean(NewLateBinding.LateGet(Instance3, (System.Type) null, "IsCompleted", new object[0], (string[]) null, (System.Type[]) null, (bool[]) null)))
          {
            // ISSUE: reference to a compiler-generated field
            this.\u0024State = num = 0;
            obj1 = Instance3;
            if (Instance3 is ICriticalNotifyCompletion notifyCompletion)
            {
              // ISSUE: reference to a compiler-generated field
              ref AsyncTaskMethodBuilder<object> local1 = ref this.\u0024Builder;
              ref ICriticalNotifyCompletion local2 = ref notifyCompletion;
              // ISSUE: variable of a compiler-generated type
              Database.VB\u0024StateMachine_198_ExecuteAsync machine198ExecuteAsync = this;
              ref Database.VB\u0024StateMachine_198_ExecuteAsync local3 = ref machine198ExecuteAsync;
              local1.AwaitUnsafeOnCompleted<ICriticalNotifyCompletion, Database.VB\u0024StateMachine_198_ExecuteAsync>(ref local2, ref local3);
              return;
            }
            INotifyCompletion notifyCompletion1 = (INotifyCompletion) Instance3;
            // ISSUE: reference to a compiler-generated field
            ref AsyncTaskMethodBuilder<object> local4 = ref this.\u0024Builder;
            ref INotifyCompletion local5 = ref notifyCompletion1;
            // ISSUE: variable of a compiler-generated type
            Database.VB\u0024StateMachine_198_ExecuteAsync machine198ExecuteAsync1 = this;
            ref Database.VB\u0024StateMachine_198_ExecuteAsync local6 = ref machine198ExecuteAsync1;
            local4.AwaitOnCompleted<INotifyCompletion, Database.VB\u0024StateMachine_198_ExecuteAsync>(ref local5, ref local6);
            return;
          }
          NewLateBinding.LateCall(Instance3, (System.Type) null, "GetResult", new object[0], (string[]) null, (System.Type[]) null, (bool[]) null, true);
          object Instance4 = NewLateBinding.LateGet(NewLateBinding.LateGet(NewLateBinding.LateGet(Instance2, (System.Type) null, "ExecuteScalarAsync", new object[0], (string[]) null, (System.Type[]) null, (bool[]) null), (System.Type) null, "ConfigureAwait", new object[1]
          {
            (object) false
          }, (string[]) null, (System.Type[]) null, (bool[]) null), (System.Type) null, "GetAwaiter", new object[0], (string[]) null, (System.Type[]) null, (bool[]) null);
          if (!Conversions.ToBoolean(NewLateBinding.LateGet(Instance4, (System.Type) null, "IsCompleted", new object[0], (string[]) null, (System.Type[]) null, (bool[]) null)))
          {
            // ISSUE: reference to a compiler-generated field
            this.\u0024State = num = 2;
            obj1 = Instance4;
            if (Instance4 is ICriticalNotifyCompletion notifyCompletion)
            {
              // ISSUE: reference to a compiler-generated field
              ref AsyncTaskMethodBuilder<object> local1 = ref this.\u0024Builder;
              ref ICriticalNotifyCompletion local2 = ref notifyCompletion;
            ...
            INotifyCompletion notifyCompletion1 = (INotifyCompletion) Instance4;
            // ISSUE: reference to a compiler-generated field
            ref AsyncTaskMethodBuilder<object> local4 = ref this.\u0024Builder;
            ref INotifyCompletion local5 = ref notifyCompletion1;
            // ISSUE: variable of a compiler-generated type
          ...
          obj2 = NewLateBinding.LateGet(Instance4, (System.Type) null, "GetResult", new object[0], (string[]) null, (System.Type[]) null, (bool[]) null);
        }
      }
