  ...
  public class CheckListSQL
  {
    ...
    public DataView Get_Questions_And_Answers_For_Section(int SectionID, int CheckListID)
    {
      ...
      if ((uint) CheckListID > 0U)
      {
        ...
        try
        {
          enumerator = table1.Rows.GetEnumerator();
          while (enumerator.MoveNext())
          {
            DataRow current = (DataRow) enumerator.Current;
            if ((uint) Helper.MakeIntegerValid(RuntimeHelpers.GetObjectValue(current["SubTaskID"])) > 0U)
            {
              if (table2.Select(Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) ("EnumTableID = " + Conversions.ToString(45) + " AND QuestionID = "), current["SubTaskID"]))).Length > 0)
              {
                DataRow dataRow = table2.Select(Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) ("EnumTableID = " + Conversions.ToString(45) + " AND QuestionID = "), current["SubTaskID"])))[0];
                current["Result"] = RuntimeHelpers.GetObjectValue(dataRow["ResultID"]);
                current["Comments"] = RuntimeHelpers.GetObjectValue(dataRow["Comments"]);
              }
            }
            else if ((uint) Helper.MakeIntegerValid(RuntimeHelpers.GetObjectValue(current["TaskID"])) > 0U)
            {
              if (table2.Select(Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) ("EnumTableID = " + Conversions.ToString(46) + " AND QuestionID = "), current["TaskID"]))).Length > 0)
              {
                DataRow dataRow = table2.Select(Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) ("EnumTableID = " + Conversions.ToString(46) + " AND QuestionID = "), current["TaskID"])))[0];
                current["Result"] = RuntimeHelpers.GetObjectValue(dataRow["ResultID"]);
                current["Comments"] = RuntimeHelpers.GetObjectValue(dataRow["Comments"]);
              }
            }
            ...
            {
              if (table2.Select(Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) ("EnumTableID = " + Conversions.ToString(43) + " AND QuestionID = "), current["AreaID"]))).Length > 0)
              {
                DataRow dataRow = table2.Select(Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) ("EnumTableID = " + Conversions.ToString(43) + " AND QuestionID = "), current["AreaID"])))[0];
                current["Result"] = RuntimeHelpers.GetObjectValue(dataRow["ResultID"]);
                current["Comments"] = RuntimeHelpers.GetObjectValue(dataRow["Comments"]);
              }
            }
            else if (table2.Select(Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) ("EnumTableID = " + Conversions.ToString(44) + " AND QuestionID = "), current[nameof (SectionID)]))).Length > 0)
            {
              DataRow dataRow = table2.Select(Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) ("EnumTableID = " + Conversions.ToString(44) + " AND QuestionID = "), current[nameof (SectionID)])))[0];
              current["Result"] = RuntimeHelpers.GetObjectValue(dataRow["ResultID"]);
              current["Comments"] = RuntimeHelpers.GetObjectValue(dataRow["Comments"]);
            }
          }
