  ...
  public class EngineerVisitSQL
  {
      ...
      bool justStatus)
    {
      ...
      if (!justStatus)
      {
        ...
        try
        {
          enumerator1 = oEngineerVisit.PartsAndProductsAllocated.Table.Rows.GetEnumerator();
      ...
      SqlTransaction trans)
    {
      ...
      if (oEngineerVisit.PartsAndProductsAllocated.Table != null)
      {
        try
        {
          enumerator = oEngineerVisit.PartsAndProductsAllocated.Table.Rows.GetEnumerator();
    ...
    public ArrayList EngineerVisits_Get_For_Job_Of_Work_As_Objects(int JobOfWorkID)
    {
      ...
      try
      {
        enumerator = this.EngineerVisits_Get_For_Job_Of_Work(JobOfWorkID).Table.Rows.GetEnumerator();
        while (enumerator.MoveNext())
        {
          DataRow current = (DataRow) enumerator.Current;
          EngineerVisit engineerVisit = new EngineerVisit()
    ...
    public ArrayList EngineerVisits_Get_For_Job_Of_Work_As_Objects_Light(int JobOfWorkID)
    {
      ...
      try
      {
        enumerator = this.EngineerVisits_Get_For_Job_Of_Work_Light(JobOfWorkID).Table.Rows.GetEnumerator();
        while (enumerator.MoveNext())
        {
          DataRow current = (DataRow) enumerator.Current;
          EngineerVisit engineerVisit = new EngineerVisit()
      ...
      SqlTransaction trans)
    {
      ...
      try
      {
        enumerator = this.EngineerVisits_Get_For_Job_Of_Work(JobOfWorkID, trans).Table.Rows.GetEnumerator();
        while (enumerator.MoveNext())
        {
          DataRow current = (DataRow) enumerator.Current;
          EngineerVisit engineerVisit = new EngineerVisit();
      ...
      DataView PartsAndProductsDistribution)
    {
      ...
      try
      {
        enumerator1 = oEngineerVisit.PartsAndProductsUsed.Table.Rows.GetEnumerator();
        while (enumerator1.MoveNext())
        {
          DataRow current = (DataRow) enumerator1.Current;
      ...
      if (oEngineerVisit.StatusEnumID < 7)
      {
          ...
          switch (oEngineerVisit.OutcomeEnumID)
          {
            case 2:
              if (oEngineerVisit.VisitNumber <= 0)
              {
                ...
                try
                {
                  enumerator2 = forJobOfWork.Table.Rows.GetEnumerator();
                  while (enumerator2.MoveNext())
                  {
                    if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectLess(((DataRow) enumerator2.Current)["StatusEnumID"], (object) 7, false))
                      flag = false;
                  }
                }
                finally
            ...
            case 5:
              ...
              try
              {
                enumerator3 = forJobOfWork1.Table.Rows.GetEnumerator();
                while (enumerator3.MoveNext())
                {
                  if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectLess(((DataRow) enumerator3.Current)["StatusEnumID"], (object) 7, false))
                    flag1 = false;
                }
              }
              finally
        ...
        if (oEngineerVisit.OutcomeEnumID == 3)
        {
          ...
          try
          {
            enumerator2 = forJobOfWork2.Table.Rows.GetEnumerator();
            while (enumerator2.MoveNext())
            {
              if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectLess(((DataRow) enumerator2.Current)["StatusEnumID"], (object) 7, false))
                flag2 = false;
      ...
      try
      {
        enumerator4 = oEngineerVisit.TimeSheets.Table.Rows.GetEnumerator();
      ...
      if (anEngineerVisitId.JobDefinitionEnumID == 2 | oEngineerVisit.GasServiceCompleted)
      {
        try
        {
          enumerator5 = anEngineerVisitId.Assets.GetEnumerator();
      ...
      if (JobItemsDataview != null)
      {
        try
        {
          enumerator6 = JobItemsDataview.Table.Rows.GetEnumerator();
    ...
    private void AllocatedDistributions(DataView PartsAndProductsDistribution)
    {
      ...
      try
      {
        ...
        {
          DataRow current = (DataRow) enumerator.Current;
          if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectEqual(current["DistributedID"], (object) 0, false))
          {
            this._database.ClearParameter();
            ...
            string Left1 = Helper.MakeStringValid(RuntimeHelpers.GetObjectValue(current["Type"]));
            ...
            if (Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectEqual(current["StockTransactionType"], (object) -1, false))
            {
              ...
              oPartsToBeCredited.SetPartOrderID = RuntimeHelpers.GetObjectValue(current["OrderPartProductID"]);
            ...
            {
              string Left2 = Helper.MakeStringValid(RuntimeHelpers.GetObjectValue(current["Type"]));
    ...
    public List<EngineerVisit> Get_ByJobId(int jobId)
    {
      ...
      Func<DataRow, EngineerVisit> selector;
      // ISSUE: reference to a compiler-generated field
      if (EngineerVisitSQL._Closure\u0024__.\u0024I64\u002D0 != null)
      {
        // ISSUE: reference to a compiler-generated field
        selector = EngineerVisitSQL._Closure\u0024__.\u0024I64\u002D0;
      }
      else
      {
        // ISSUE: reference to a compiler-generated field
        EngineerVisitSQL._Closure\u0024__.\u0024I64\u002D0 = selector = (Func<DataRow, EngineerVisit>) (x => new EngineerVisit()
        {
          Exists = true,
      ...
      return source2.Select<DataRow, EngineerVisit>(selector).ToList<EngineerVisit>();
    }
  }
}
