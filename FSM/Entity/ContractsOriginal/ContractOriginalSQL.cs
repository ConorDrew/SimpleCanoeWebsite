    ...
    public class ContractOriginalSQL
    {
        ...
        public DataTable ProcessContract(int contractId)
        {
            ...
            try
            {
                ...
                {
                    string Left = !Information.IsDBNull(RuntimeHelpers.GetObjectValue(dr["Type"])) ? Conversions.ToString(dr["Type"]) : "";
                    string str = "0";
                    if (!Information.IsDBNull(RuntimeHelpers.GetObjectValue(dr["Printed"])))
                        str = Conversions.ToString(dr["Printed"]);
                    if (Conversions.ToBoolean(str) | Information.IsDBNull(RuntimeHelpers.GetObjectValue(dr["Processed"])) | Helper.MakeBooleanValid(RuntimeHelpers.GetObjectValue(dr["Processed"])))
                    {
                        DataTable dataTable2 = App.DB.ExecuteWithReturn(Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object)"select * from tblInvoicedLines il INNER join tblInvoiced i on i.InvoicedID = il.InvoicedID WHERE InvoiceToBeRaisedID = ", dr["InvoiceToBeRaisedID"])), true);
                        if (dataTable2.Rows.Count > 0)
                            dr["InvoiceNumber"] = RuntimeHelpers.GetObjectValue(dataTable2.Rows[0]["InvoiceNumber"]);
                    }
                    else if (!Conversions.ToBoolean(Microsoft.VisualBasic.CompilerServices.Operators.OrObject(Microsoft.VisualBasic.CompilerServices.Operators.OrObject((object)(Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Left, "TRANS", false) == 0 | Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Left, "AMEND", false) == 0), Microsoft.VisualBasic.CompilerServices.Operators.AndObject((object)(Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Left, "RENEWAL", false) == 0), Microsoft.VisualBasic.CompilerServices.Operators.OrObject(Microsoft.VisualBasic.CompilerServices.Operators.CompareObjectEqual(dr["InvoiceFrequencyID"], (object)Enums.InvoiceFrequency.AnnuallyDD, false), Microsoft.VisualBasic.CompilerServices.Operators.CompareObjectEqual(dr["InvoiceFrequencyID"], (object)Enums.InvoiceFrequency.Monthly, false)))), Microsoft.VisualBasic.CompilerServices.Operators.AndObject(Microsoft.VisualBasic.CompilerServices.Operators.CompareObjectEqual(Microsoft.VisualBasic.CompilerServices.Operators.ModObject(dr["installments"], (object)12), (object)0, false), Microsoft.VisualBasic.CompilerServices.Operators.CompareObjectNotEqual(dr["installments"], (object)0, false)))))
                    {
                        DataTable dataTable2 = App.DB.ExecuteWithReturn(Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object)"select * from tblInvoicedLines il INNER join tblInvoiced i on i.InvoicedID = il.InvoicedID WHERE InvoiceToBeRaisedID = ", dr["InvoiceToBeRaisedID"])), true);
                        if (dataTable2.Rows.Count > 0)
                        {
                        ...
                        else
                        {
                            ...
                            oInvoiced.RaisedDate = Conversions.ToDate(dr["RaiseDate"]);
                            ...
                            {
                                SetAmount = !Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectEqual(dr["InvoiceFrequencyID"], (object)Enums.InvoiceFrequency.Monthly, false) ? RuntimeHelpers.GetObjectValue(dr["ContractPrice"]) : Microsoft.VisualBasic.CompilerServices.Operators.DivideObject(dr["FirstAmount"], (object)1.2),
                                SetInvoicedID = (object)invoiced.InvoicedID,
                                SetInvoiceToBeRaisedID = RuntimeHelpers.GetObjectValue(dr["InvoiceToBeRaisedID"])
                            });
                            dr["InvoiceNumber"] = (object)invoiced.InvoiceNumber;
                        }
                    }
                }
