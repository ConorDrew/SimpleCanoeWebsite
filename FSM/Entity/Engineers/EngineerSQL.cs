...
namespace FSM.Entity.Engineers
{
    public class EngineerSQL
    {
          ...
          DateTime EndDate)
        {
            ...
            {
                string str2 = Conversions.ToString(month);
                str1 = str1 + str2 + ";";
            }
        ...
        public void SaveDisciplinaryRecords(int engineerID, DataTable t)
        {
            ...
            foreach (DataRow dr in t.Rows)
            {
                this._database.ClearParameter();
                this._database.AddParameter("@EngineerID", (object)engineerID, true);
                this._database.AddParameter("@Disciplinary", (object)Helper.MakeStringValid(RuntimeHelpers.GetObjectValue(dr["Disciplinary"])), true);
                this._database.AddParameter("@DateIssued", RuntimeHelpers.GetObjectValue(dr["DateIssued"]), true);
                this._database.AddParameter("@DisciplinaryStatusID", RuntimeHelpers.GetObjectValue(dr["DisciplinaryStatusID"]), true);
        ...
        public void SaveEquipmentRecords(int engineerID, DataTable t)
        {
            ...
            foreach (DataRow dr in t.Rows)
            {
                this._database.ClearParameter();
                this._database.AddParameter("@EngineerID", (object)engineerID, true);
                this._database.AddParameter("@Equipment", (object)Helper.MakeStringValid(RuntimeHelpers.GetObjectValue(dr["Equipment"])), true);
