...
// Type: FSM.Entity.QuoteContractOriginals.QuoteContractOriginal
...
{
    public class QuoteContractOriginal
    {
        ...
        public string ReasonForRejectID
        {
            get
            {
                return Conversions.ToString(this._ReasonForRejectID);
            }
        }
