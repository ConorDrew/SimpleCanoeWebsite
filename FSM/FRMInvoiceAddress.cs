...
namespace FSM
{
  public class FRMInvoiceAddress : FRMBaseForm, IForm
  {
    ...
    public FRMInvoiceAddress()
    {
      this.Load += new EventHandler(this.FRMInvoiceAddress_Load);
      this._ID = 0;
      this.InitializeComponent();
      this.TheLoadedControl = (IUserControl) new UCInvoiceAddress();
    ...
    private void InitializeComponent()
    {
      ...
      this.btnSave.Location = new System.Drawing.Point(8, 375);
      this.btnSave.Name = "btnSave";
      this.btnSave.Size = new Size(56, 25);
      this.btnSave.TabIndex = 2;
      this.btnSave.Text = "Save";
      this.btnClose.Anchor = AnchorStyles.Bottom | AnchorStyles.Left;
      this.btnClose.Location = new System.Drawing.Point(72, 375);
      ...
      this.pnlMain.Location = new System.Drawing.Point(4, 37);
      this.pnlMain.Name = "pnlMain";
      this.pnlMain.Size = new Size(625, 327);
      this.pnlMain.TabIndex = 1;
      this.AutoScaleBaseSize = new Size(6, 14);
      this.ClientSize = new Size(632, 413);
      this.Controls.Add((Control) this.btnClose);
      this.Controls.Add((Control) this.btnSave);
      this.Controls.Add((Control) this.pnlMain);
      this.MaximizeBox = false;
      this.MinimizeBox = false;
      this.MinimumSize = new Size(640, 447);
      this.Name = nameof (FRMInvoiceAddress);
      this.Text = "Invoice Address : ID {0}";
    ...
    void IForm.LoadMe(object sender, EventArgs e)
    {
      ...
      ((UCInvoiceAddress) this.LoadedControl).SiteID = Helper.MakeIntegerValid(RuntimeHelpers.GetObjectValue(this.get_GetParameter(1)));
      ((UCInvoiceAddress) this.LoadedControl).CurrentInvoiceAddress = App.DB.InvoiceAddress.InvoiceAddress_Get(this.ID);
    ...
    {
      this.ID = newID;
      if (!Operators.ConditionalCompareObjectNotEqual(NewLateBinding.LateGet(this.get_GetParameter(2), (System.Type) null, "name", new object[0], (string[]) null, (System.Type[]) null, (bool[]) null), (object) "FRMSelectInvoiceAddress", false))
        return;
      ((UCSite) this.get_GetParameter(2)).PopulateInvoiceAddresses();
    }
    ...
    public int ID
    {
      ...
      set
      {
        ...
        if (this.ID == 0)
        {
          ...
          this.Text = "Invoice Address : Adding New...";
        }
        else
        {
          this.PageState = Enums.FormState.Update;
          this.Text = "Invoice Address : ID " + Conversions.ToString(this.ID);
        }
      }
    }
    ...
    private void FRMInvoiceAddress_Load(object sender, EventArgs e)
    {
