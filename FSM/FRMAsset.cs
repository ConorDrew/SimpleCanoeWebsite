...
namespace FSM
{
  public class FRMAsset : FRMBaseForm, IForm
  {
    ...
    public FRMAsset()
    {
      this.Load += new EventHandler(this.FRMAsset_Load);
      this._ID = 0;
      this.InitializeComponent();
      this.TheLoadedControl = (IUserControl) new UCAsset();
    ...
    private void InitializeComponent()
    {
      ...
      this.btnSave.Location = new System.Drawing.Point(8, 675);
      this.btnSave.Name = "btnSave";
      this.btnSave.Size = new Size(56, 25);
      this.btnSave.TabIndex = 2;
      this.btnSave.Text = "Save";
      this.btnClose.Anchor = AnchorStyles.Bottom | AnchorStyles.Left;
      this.btnClose.Location = new System.Drawing.Point(72, 675);
      ...
      this.pnlMain.Location = new System.Drawing.Point(6, 35);
      this.pnlMain.Name = "pnlMain";
      this.pnlMain.Size = new Size(775, 635);
      this.pnlMain.TabIndex = 1;
      this.AutoScaleBaseSize = new Size(6, 14);
      this.ClientSize = new Size(786, 713);
      this.Controls.Add((Control) this.btnClose);
      this.Controls.Add((Control) this.btnSave);
      this.Controls.Add((Control) this.pnlMain);
      this.MaximizeBox = false;
      this.MinimizeBox = false;
      this.MinimumSize = new Size(656, 601);
      this.Name = nameof (FRMAsset);
    ...
    void IForm.LoadMe(object sender, EventArgs e)
    {
      ...
      try
      {
        ((UCAsset) this.LoadedControl).LoadProductID = Helper.MakeIntegerValid(RuntimeHelpers.GetObjectValue(this.get_GetParameter(1)));
        ((UCAsset) this.LoadedControl).LoadSiteID = Helper.MakeIntegerValid(RuntimeHelpers.GetObjectValue(this.get_GetParameter(2)));
      }
      catch (Exception ex)
      {
      ...
      ((UCAsset) this.LoadedControl).CurrentAsset = App.DB.Asset.Asset_Get(this.ID);
      this.LoadForm(RuntimeHelpers.GetObjectValue(sender), e, (IForm) this);
      ((UCAsset) this.LoadedControl).SetupJobsDataGrid();
    }
    ...
    public int ID
    {
      ...
      set
      {
        ...
        if (this.ID == 0)
        {
          ...
          this.Text = "Asset : Adding New...";
        }
        else
        {
          this.PageState = Enums.FormState.Update;
          FSM.Entity.Sites.Site site1 = new FSM.Entity.Sites.Site();
          FSM.Entity.Sites.Site site2 = App.DB.Sites.Get((object) this.ID, SiteSQL.GetBy.Asset, (object) null);
          FSM.Entity.Customers.Customer customer = new FSM.Entity.Customers.Customer();
          FSM.Entity.Customers.Customer forSiteId = App.DB.Customer.Customer_Get_ForSiteID(site2.SiteID);
          this.Text = "Asset : ID " + Conversions.ToString(this.ID) + " for Property: " + site2.Name + ", " + site2.Postcode + ", Customer: " + forSiteId.Name + ", Acc: " + forSiteId.AccountNumber;
        }
      }
    }
    ...
    private void btnSave_Click(object sender, EventArgs e)
    {
      if (!this.LoadedControl.Save())
        return;
      if (((UCAsset) this.LoadedControl).LoadSiteID > 0)
      {
        if (this.Modal)
          this.Close();
        else
