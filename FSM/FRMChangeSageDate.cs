...
{
  [DesignerGenerated]
  public class FRMChangeSageDate : FRMBaseForm, IForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.GroupBox1.Size = new Size(502, 171);
      ...
      this.Label3.Text = "Sage Date";
      this.btnSave.Enabled = false;
      this.btnSave.Location = new System.Drawing.Point(410, 136);
      ...
      this.ClientSize = new Size(526, 221);
      this.Controls.Add((Control) this.GroupBox1);
      this.Name = nameof (FRMChangeSageDate);
    ...
    {
      this.dtpTaxDate.Value = Helper.MakeDateTimeValid(RuntimeHelpers.GetObjectValue(App.DB.ExecuteScalar("Select Name from tblpicklists where enumtypeid = 69", false, true)));
    ...
    {
      App.DB.ExecuteScalar("UPDATE tblpicklists SET Name = '" + Strings.Format((object) this.dtpTaxDate.Value, "yyyy-MM-dd") + "' where enumtypeid = 69", false, true);
