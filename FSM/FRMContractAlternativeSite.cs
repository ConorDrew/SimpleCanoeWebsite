...
// Type: FSM.FRMContractAlternativeSite
...
namespace FSM
{
  public class FRMContractAlternativeSite : FRMBaseForm, IForm
  {
    ...
    public FRMContractAlternativeSite()
    {
      this.Load += new EventHandler(this.FRMContractSite_Load);
      this._ID = 0;
      this._SiteID = 0;
      this.InitializeComponent();
      this.TheLoadedControl = (IUserControl) new UCContractAlternativeSite();
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = nameof (FRMContractAlternativeSite);
    ...
    void IForm.LoadMe(object sender, EventArgs e)
    {
      ...
      this.CurrentContract = (ContractAlternative) this.get_GetParameter(2);
      ((UCContractAlternativeSite) this.LoadedControl).SiteID = this.SiteID;
      ((UCContractAlternativeSite) this.LoadedControl).CurrentContract = this.CurrentContract;
      ((UCContractAlternativeSite) this.LoadedControl).CurrentContractSite = App.DB.ContractAlternativeSite.Get(this.ID);
      ((UCContractAlternativeSite) this.LoadedControl).PopAssets();
      ((UCContractAlternativeSite) this.LoadedControl).SetupAssetsDataGrid();
      ((UCContractAlternativeSite) this.LoadedControl).SetupJobItemsDataGrid();
