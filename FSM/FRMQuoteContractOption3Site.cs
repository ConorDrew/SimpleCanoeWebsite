...
// Type: FSM.FRMQuoteContractOption3Site
...
namespace FSM
{
  public class FRMQuoteContractOption3Site : FRMBaseForm, IForm
  {
    ...
    public FRMQuoteContractOption3Site()
    {
      this.Load += new EventHandler(this.FRMContractOption3Site_Load);
      this._ID = 0;
      this.InitializeComponent();
      this.TheLoadedControl = (IUserControl) new UCQuoteContractOption3Site();
    ...
    private void InitializeComponent()
    {
      ...
      this.pnlMain.Size = new Size(994, 616);
      this.pnlMain.TabIndex = 1;
      this.AutoScaleBaseSize = new Size(6, 14);
      this.ClientSize = new Size(1002, 694);
      this.Controls.Add((Control) this.btnClose);
      this.Controls.Add((Control) this.btnSave);
      this.Controls.Add((Control) this.pnlMain);
      this.MaximizeBox = false;
      this.MinimizeBox = false;
      this.MinimumSize = new Size(1010, 728);
      this.Name = "FRMContractOption3Site";
      this.Text = "Contract Option3 Property : ID {0}";
    ...
    void IForm.LoadMe(object sender, EventArgs e)
    {
      ...
      ((UCQuoteContractOption3Site) this.LoadedControl).CurrentQuoteContractOption3Site = App.DB.QuoteContractOption3Site.QuoteContractOption3Site_Get(this.ID);
      this.LoadForm(RuntimeHelpers.GetObjectValue(sender), e, (IForm) this);
      ((UCQuoteContractOption3Site) this.LoadedControl).SetupAssetsDataGrid();
    }
    ...
    private void FRMContractOption3Site_Load(object sender, EventArgs e)
    {
