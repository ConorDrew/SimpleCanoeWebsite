...
namespace FSM
{
  public class FRMWarehouse : FRMBaseForm, IForm
  {
    ...
    public FRMWarehouse()
    {
      ...
      this.TheLoadedControl = (IUserControl) new UCWarehouse();
    ...
    private void InitializeComponent()
    {
      ...
      this.btnSave.Location = new System.Drawing.Point(8, 532);
      this.btnSave.Name = "btnSave";
      this.btnSave.Size = new Size(56, 25);
      this.btnSave.TabIndex = 2;
      this.btnSave.Text = "Save";
      this.btnClose.Anchor = AnchorStyles.Bottom | AnchorStyles.Left;
      this.btnClose.Location = new System.Drawing.Point(72, 532);
      ...
      this.pnlMain.Size = new Size(641, 491);
      this.pnlMain.TabIndex = 1;
      this.AutoScaleBaseSize = new Size(6, 14);
      this.ClientSize = new Size(648, 570);
      this.Controls.Add((Control) this.btnClose);
      this.Controls.Add((Control) this.btnSave);
      this.Controls.Add((Control) this.pnlMain);
      this.MaximizeBox = false;
      this.MinimizeBox = false;
      this.MinimumSize = new Size(656, 604);
      this.Name = nameof (FRMWarehouse);
      this.Text = "Warehouse : ID {0}";
    ...
    void IForm.LoadMe(object sender, EventArgs e)
    {
      ...
      ((UCWarehouse) this.LoadedControl).CurrentWarehouse = App.DB.Warehouse.Warehouse_Get(this.ID);
      this.LoadForm(RuntimeHelpers.GetObjectValue(sender), e, (IForm) this);
      ((UCWarehouse) this.LoadedControl).SetupPartsDatagrid();
      ((UCWarehouse) this.LoadedControl).SetupProductsDatagrid();
      ((UCWarehouse) this.LoadedControl).SetupVansDatagrid();
    }
    ...
    public int ID
    {
      ...
      set
      {
        ...
        if (this.ID == 0)
        {
          ...
          this.Text = "Warehouse : Adding New...";
        }
        else
        {
          this.PageState = Enums.FormState.Update;
          this.Text = "Warehouse : ID " + Conversions.ToString(this.ID);
        }
      }
    }
