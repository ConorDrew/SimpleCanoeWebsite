...
namespace FSM
{
  public class UCASHPWorksheet : UCBase, IUserControl
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = nameof (UCASHPWorksheet);
    ...
    public bool Save()
    {
      ...
      try
      {
        ...
        this.Worksheet.SetReading = (object) 5;
        ...
        new EngineerVisitAssetWorkSheetValidatorASHP().Validate(this.Worksheet);
