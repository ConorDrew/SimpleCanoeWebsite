...
namespace FSM
{
  public class FRMUserQualification : FRMBaseForm, IForm
  {
    ...
    public FRMUserQualification()
    {
      this.Load += new EventHandler(this.FRMUserQualification_Load);
      this._ID = 0;
      this.InitializeComponent();
      this.TheLoadedControl = (IUserControl) new UCUserQualification();
    ...
    private void InitializeComponent()
    {
      ...
      this.btnSave.Location = new System.Drawing.Point(8, 719);
      this.btnSave.Name = "btnSave";
      this.btnSave.Size = new Size(56, 25);
      this.btnSave.TabIndex = 2;
      this.btnSave.Text = "Save";
      this.btnClose.Anchor = AnchorStyles.Bottom | AnchorStyles.Left;
      this.btnClose.Location = new System.Drawing.Point(72, 719);
      ...
      this.pnlMain.Size = new Size(630, 679);
      this.pnlMain.TabIndex = 1;
      this.AutoScaleBaseSize = new Size(6, 14);
      this.ClientSize = new Size(638, 757);
      ...
      this.Name = nameof (FRMUserQualification);
      this.Text = "User Qualifications";
    ...
    void IForm.LoadMe(object sender, EventArgs e)
    {
      ...
      ((UCUserQualification) this.LoadedControl).CurrentUser = App.DB.User.Get(this.ID, false);
      this.LoadForm(RuntimeHelpers.GetObjectValue(sender), e, (IForm) this);
      ((UCUserQualification) this.LoadedControl).SetupTrainingQualificationsDataGrid();
    }
    ...
    private void FRMUserQualification_Load(object sender, EventArgs e)
    {
