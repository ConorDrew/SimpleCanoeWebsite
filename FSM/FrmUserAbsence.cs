...
namespace FSM
{
  public class FrmUserAbsence : FRMBaseForm
  {
    ...
    public FrmUserAbsence(int absenceID = 0)
    {
      this.Load += new EventHandler(this.FrmUserAbsence_Load);
      this._absenceID = 0;
      this.InitializeComponent();
      this.AbsenceID = absenceID;
      this.TheLoadedControl = (IUserControl) new UCAbsences(Enums.UserType.User, absenceID);
    ...
    private void InitializeComponent()
    {
      ...
      this.btnCancel.Location = new System.Drawing.Point(8, 314);
      ...
      this.btnSave.Location = new System.Drawing.Point(552, 314);
      ...
      this.Name = nameof (FrmUserAbsence);
