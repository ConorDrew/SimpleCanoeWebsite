...
// Type: FSM.FRMContractOption3Site
...
namespace FSM
{
  public class FRMContractOption3Site : FRMBaseForm, IForm
  {
    ...
    public FRMContractOption3Site()
    {
      this.Load += new EventHandler(this.FRMContractOption3Site_Load);
      this._ID = 0;
      this.InitializeComponent();
      this.TheLoadedControl = (IUserControl) new UCContractOption3Site();
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = nameof (FRMContractOption3Site);
    ...
    void IForm.LoadMe(object sender, EventArgs e)
    {
      ...
      ((UCContractOption3Site) this.LoadedControl).SetupAssetsDataGrid();
      ((UCContractOption3Site) this.LoadedControl).SetupPPMDataGrid();
      ((UCContractOption3Site) this.LoadedControl).SetupInvoiceAddressDataGrid();
      this.ID = Helper.MakeIntegerValid(RuntimeHelpers.GetObjectValue(this.get_GetParameter(0)));
      ((UCContractOption3Site) this.LoadedControl).CurrentContractOption3Site = App.DB.ContractOption3Site.ContractOption3Site_Get(this.ID);
    }
