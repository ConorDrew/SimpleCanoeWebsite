...
namespace FSM
{
  public class FRMFleetEquipment : FRMBaseForm, IForm
  {
    ...
    public FRMFleetEquipment()
    {
      this.Load += new EventHandler(this.FRMVan_Load);
      this._ID = 0;
      this.InitializeComponent();
      this.TheLoadedControl = (IUserControl) new UCFleetEquipment();
    ...
    private void InitializeComponent()
    {
      ...
      this.btnSave.Location = new System.Drawing.Point(8, 141);
      this.btnSave.Name = "btnSave";
      this.btnSave.Size = new Size(56, 25);
      this.btnSave.TabIndex = 2;
      this.btnSave.Text = "Save";
      this.btnClose.Anchor = AnchorStyles.Bottom | AnchorStyles.Left;
      this.btnClose.Location = new System.Drawing.Point(72, 141);
      ...
      this.pnlMain.Size = new Size(439, 103);
      this.pnlMain.TabIndex = 1;
      this.AutoScaleBaseSize = new Size(6, 14);
      this.ClientSize = new Size(439, 179);
      this.Controls.Add((Control) this.btnClose);
      this.Controls.Add((Control) this.btnSave);
      this.Controls.Add((Control) this.pnlMain);
      this.MaximizeBox = false;
      this.MinimizeBox = false;
      this.Name = nameof (FRMFleetEquipment);
      this.Text = "Equipment: ID {0}";
    ...
    void IForm.LoadMe(object sender, EventArgs e)
    {
      ...
      ((UCFleetEquipment) this.LoadedControl).CurrentEquipment = App.DB.FleetEquipment.Get(this.ID);
    ...
    public int ID
    {
      ...
      set
      {
        ...
        if (this.ID == 0)
        {
          ...
          this.Text = "Equipment: Adding New...";
        }
        else
        {
          this.PageState = Enums.FormState.Update;
          this.Text = "Equipment: ID " + Conversions.ToString(this.ID);
        }
      }
    }
