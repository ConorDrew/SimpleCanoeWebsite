...
// Type: FSM.Contract3AssetsColourColumnConvert
...
namespace FSM
{
  public class Contract3AssetsColourColumnConvert : DataGridEditableTextBoxColumn
  {
    ...
    public object theUserControl
    {
      get
      {
        return this._theUserControl;
      }
      set
      {
        this._theUserControl = RuntimeHelpers.GetObjectValue(value);
      }
    }
      ...
      bool alignToRight)
    {
      ...
      else
      {
        ...
        this.TextBox.TextChanged += new EventHandler(this.SaveDuration);
      }
    ...
    {
      ((UCQuoteContractOption3Convert) this.theUserControl).UpdateDurations(Helper.MakeDoubleValid((object) ((TextBox) sender).Text), Conversions.ToDate("01" + this.MappingName.ToString()));
    }
  }
}
