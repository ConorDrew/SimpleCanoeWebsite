...
namespace FSM
{
  public class FRMEquipment : FRMBaseForm, IForm
  {
    ...
    public FRMEquipment()
    {
      ...
      this.TheLoadedControl = (IUserControl) new UCEquipment();
    ...
    void IForm.LoadMe(object sender, EventArgs e)
    {
      ...
      ((UCEquipment) this.LoadedControl).CurrentEquipment = App.DB.Engineer.Equipment_Get(this.ID);
