...
namespace FSM
{
  public class FRMFleetVan : FRMBaseForm, IForm
  {
    ...
    public FRMFleetVan()
    {
      ...
      this.TheLoadedControl = (IUserControl) new UCFleetVan();
    ...
    private void InitializeComponent()
    {
      ...
      this.btnClose.Location = new System.Drawing.Point(625, 888);
      ...
      this.pnlMain.Size = new Size(693, 847);
      this.pnlMain.TabIndex = 1;
      this.btnSave.Anchor = AnchorStyles.Bottom | AnchorStyles.Left;
      this.btnSave.Location = new System.Drawing.Point(12, 888);
      ...
      this.ClientSize = new Size(693, 925);
    ...
    void IForm.LoadMe(object sender, EventArgs e)
    {
      ...
      ((UCFleetVan) this.LoadedControl).CurrentVan = App.DB.FleetVan.Get(this.ID);
    }
    ...
    public int ID
    {
      ...
      set
      {
        ...
        if (this.ID == 0)
        {
          ...
          this.Text = "Fleet Van : Adding New...";
          this.btnSave.Visible = true;
        }
        else
        {
          this.PageState = Enums.FormState.Update;
          this.Text = "Fleet Van : ID " + Conversions.ToString(this.ID);
          this.btnSave.Visible = false;
        }
      }
    }
