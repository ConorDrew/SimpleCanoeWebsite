...
{
  [DesignerGenerated]
  public class FRMPartsUsed : FRMBaseForm, IForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = nameof (FRMPartsUsed);
      this.Text = "Parts Used";
    ...
    private void SetupPartsUsedDataGrid()
    {
      ...
      dataGridLabelColumn1.HeaderText = "Order Ref";
      ...
      dataGridLabelColumn3.HeaderText = "PO No";
      dataGridLabelColumn3.MappingName = "PONumber";
      ...
      dataGridLabelColumn7.HeaderText = "Engineer";
      dataGridLabelColumn7.MappingName = "Engineer";
      ...
      dataGridLabelColumn8.HeaderText = "Buy Price";
      dataGridLabelColumn8.MappingName = "BuyPrice";
      ...
      dataGridLabelColumn9.HeaderText = "SellPrice";
      dataGridLabelColumn9.MappingName = "SellPrice";
      dataGridLabelColumn9.ReadOnly = true;
      dataGridLabelColumn9.Width = 70;
      ...
      dataGridLabelColumn10.HeaderText = "Part Name";
      dataGridLabelColumn10.MappingName = "Name";
      dataGridLabelColumn10.ReadOnly = true;
      dataGridLabelColumn10.Width = 70;
      ...
      dataGridLabelColumn11.HeaderText = "PartNumber";
      dataGridLabelColumn11.MappingName = "Number";
      dataGridLabelColumn11.ReadOnly = true;
      dataGridLabelColumn11.Width = 70;
      ...
      dataGridLabelColumn12.HeaderText = "Qty";
      dataGridLabelColumn12.MappingName = "Quantity";
      dataGridLabelColumn12.ReadOnly = true;
      dataGridLabelColumn12.Width = 35;
      ...
      dataGridLabelColumn13.Format = "dd/MM/yyyy";
      dataGridLabelColumn13.FormatInfo = (IFormatProvider) null;
      dataGridLabelColumn13.HeaderText = "Visit Date";
      dataGridLabelColumn13.MappingName = "StartDateTime";
      dataGridLabelColumn13.ReadOnly = true;
      dataGridLabelColumn13.Width = 70;
      ...
      dataGridLabelColumn14.HeaderText = "Job Type";
      dataGridLabelColumn14.MappingName = "JobType";
      dataGridLabelColumn14.ReadOnly = true;
      dataGridLabelColumn14.Width = 70;
    ...
    public void PopulateDatagrid()
    {
      try
      {
        this.PartsDataview = App.DB.EngineerVisitsPartsAndProducts.Parts_Used_Report(Conversions.ToDate(Strings.Format((object) this.dtpFrom.Value, "dd-MMM-yyyy") + " 00:00:00"), Conversions.ToDate(Strings.Format((object) this.dtpTo.Value, "dd-MMM-yyyy") + " 23:59:59"));
      }
      catch (Exception ex)
      {
    ...
    public void Export()
    {
      ...
      datatableIn.Columns.Add(new DataColumn("UPRN"));
      ...
      while (row1 <= num)
      {
        ...
        row2["UPRN"] = RuntimeHelpers.GetObjectValue(this.SelectedPartDataRow["UPRN"]);
