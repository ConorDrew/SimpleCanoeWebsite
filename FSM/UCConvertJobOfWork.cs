...
namespace FSM
{
  public class UCConvertJobOfWork : UCBase, IUserControl
  {
    ...
    private UCQuoteContractAlternativeConvert _onControl;
    private QuoteContractAlternativeSiteJobOfWork _CurrentJobOfWork;
    private DataView _JobItemsAddedDataView;
    private DataView _ScheduleOfRatesDataview;
    private bool _isLoading;

    public UCConvertJobOfWork()
    {
      this.Load += new EventHandler(this.UCJobOfWork_Load);
      this._onControl = (UCQuoteContractAlternativeConvert) null;
    ...
    private void InitializeComponent()
    {
      ...
      this.SuspendLayout();
      this.Label8.Location = new System.Drawing.Point(224, 272);
      ...
      this.grpScheduleOfRates.Size = new Size(432, 312);
      ...
      this.btnSiteScheduleOfRates.Location = new System.Drawing.Point(96, 280);
      ...
      this.btnAddRates.Location = new System.Drawing.Point(8, 280);
      ...
      this.btnRemoveRates.Location = new System.Drawing.Point(352, 282);
      ...
      this.txtItemTotal.Location = new System.Drawing.Point(360, 200);
      this.txtItemTotal.MaxLength = 50;
      this.txtItemTotal.Name = "txtItemTotal";
      this.txtItemTotal.Size = new Size(88, 21);
      ...
      this.txtPricePerVisit.Location = new System.Drawing.Point(128, 296);
      this.txtPricePerVisit.MaxLength = 9;
      this.txtPricePerVisit.Name = "txtPricePerVisit";
      this.txtPricePerVisit.Size = new Size(88, 21);
      ...
      this.lblPricePerVisit.Location = new System.Drawing.Point(8, 296);
      this.lblPricePerVisit.Name = "lblPricePerVisit";
      this.lblPricePerVisit.Size = new Size(120, 20);
      this.lblPricePerVisit.TabIndex = 132;
      ...
      this.txtMileageCostPerVisit.Location = new System.Drawing.Point(360, 248);
      this.txtMileageCostPerVisit.Name = "txtMileageCostPerVisit";
      this.txtMileageCostPerVisit.Size = new Size(88, 21);
      this.txtMileageCostPerVisit.TabIndex = 8;
      this.txtMileageCostPerVisit.Text = "";
      this.txtAverageMileage.Location = new System.Drawing.Point(128, 224);
      this.txtAverageMileage.Name = "txtAverageMileage";
      this.txtAverageMileage.Size = new Size(88, 21);
      this.txtAverageMileage.TabIndex = 5;
      this.txtAverageMileage.Text = "0";
      this.txtCostPerMile.Location = new System.Drawing.Point(360, 224);
      this.txtCostPerMile.Name = "txtCostPerMile";
      this.txtCostPerMile.Size = new Size(88, 21);
      this.txtCostPerMile.TabIndex = 6;
      this.txtCostPerMile.Text = "£0.00";
      this.chkIncludeMileage.Location = new System.Drawing.Point(8, 248);
      this.chkIncludeMileage.Name = "chkIncludeMileage";
      this.chkIncludeMileage.Size = new Size(208, 21);
      ...
      this.dtpFirstVisitDate.Size = new Size(112, 21);
      ...
      this.lblFirstVisitDate.Location = new System.Drawing.Point(8, 200);
      this.lblFirstVisitDate.Name = "lblFirstVisitDate";
      this.lblFirstVisitDate.Size = new Size(96, 16);
      this.lblFirstVisitDate.TabIndex = 122;
      ...
      this.Name = nameof (UCConvertJobOfWork);
    ...
    public event UCConvertJobOfWork.RemovedItemEventHandler RemovedItem;
    ...
    public QuoteContractAlternativeSiteJobOfWork CurrentJobOfWork
    {
      get
      {
      ...
      set
      {
        ...
        this.txtCostPerMile.Text = Strings.Format((object) App.DB.CustomerCharge.CustomerCharge_GetForSite(((QuoteContractAlternativeSite) this.OnControl.SiteArray[this.OnControl.dgSites.CurrentRowIndex]).SiteID).MileageRate, "C");
        this.txtPricePerVisit.Text = "£0.00";
        this.ScheduleOfRatesDataview = this.BuildUpScheduleOfRatesDataview();
        if (this._CurrentJobOfWork == null)
        {
          this._CurrentJobOfWork = new QuoteContractAlternativeSiteJobOfWork();
          this.dtpFirstVisitDate.Value = this.OnControl.CurrentQuoteContract.ContractStart.AddDays(1.0);
          this._CurrentJobOfWork.FirstVisitDate = this.OnControl.CurrentQuoteContract.ContractStart.AddDays(1.0);
        }
        this.dtpFirstVisitDate.Value = this._CurrentJobOfWork.FirstVisitDate;
        this.JobItemsAddedDataView = App.DB.QuoteContractAlternativeSiteJobItems.GetAll_For_JobOfWorkID(this._CurrentJobOfWork.QuoteContractSiteJobOfWorkID);
    ...
    {
      if (this.OnControl.IsLoading)
        return;
      if (DateTime.Compare(this.dtpFirstVisitDate.Value, this.OnControl.CurrentQuoteContract.ContractStart) < 0 | DateTime.Compare(this.dtpFirstVisitDate.Value, this.OnControl.CurrentQuoteContract.ContractEnd) > 0)
      {
      ...
      {
        UCQuoteContractAlternativeConvert onControl = this.OnControl;
        ((QuoteContractAlternativeSiteJobOfWork) ((QuoteContractAlternativeSite) onControl.SiteArray[onControl.dgSites.CurrentRowIndex]).JobOfWorks[this.OnControl.TCJobsOfWork.SelectedIndex]).FirstVisitDate = this.dtpFirstVisitDate.Value;
      }
    }

    private void dgJobItemsAdded_MouseUp(object sender, MouseEventArgs e)
    {
      if (this.dgJobItemsAdded.HitTest(e.X, e.Y).Column != 4)
        return;
      App.ShowForm(typeof (FRMQuoteJobItemAssets), true, new object[1]
      {
        this.SelectedJobItemsDataRow["QuoteContractSiteJobItemID"]
      }, false);
    }
    ...
    private void btnAddRates_Click(object sender, EventArgs e)
    {
      ...
      if (flag)
      {
        ...
        this.CalculateRates();
        this.CalculateSiteTotal();
        this.CurrentJobOfWork.ScheduledOfRates_UsedForConvertOnly = this.ScheduleOfRatesDataview;
      }
      else
      {
    ...
    {
      int siteId = ((QuoteContractAlternativeSite) this.OnControl.SiteArray[this.OnControl.dgSites.CurrentRowIndex]).SiteID;
      DataView scheduleOfRatesDataview = this.ScheduleOfRatesDataview;
      ref DataView local = ref scheduleOfRatesDataview;
      FRMSiteScheduleOfRateList scheduleOfRateList1 = new FRMSiteScheduleOfRateList(siteId, ref local, false, false);
    ...
    void IUserControl.Populate(int ID = 0)
    {
      ...
      this.ScheduleOfRatesDataview = this.CurrentJobOfWork.ScheduledOfRates_UsedForConvertOnly;
      this.CalculateRates();
      this.CalculateMileageTotal();
