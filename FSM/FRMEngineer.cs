...
namespace FSM
{
  public class FRMEngineer : FRMBaseForm, IForm
  {
    ...
    public FRMEngineer()
    {
      ...
      this.TheLoadedControl = (IUserControl) new UCEngineer();
    ...
    private void InitializeComponent()
    {
      ...
      this.pnlMain.Size = new Size(604, 679);
      this.pnlMain.TabIndex = 1;
      this.AutoScaleBaseSize = new Size(6, 14);
      this.ClientSize = new Size(616, 761);
      this.Controls.Add((Control) this.btnClose);
      this.Controls.Add((Control) this.btnSave);
      this.Controls.Add((Control) this.pnlMain);
      this.MaximizeBox = false;
      this.MinimizeBox = false;
      this.MinimumSize = new Size(629, 627);
      this.Name = nameof (FRMEngineer);
    ...
    void IForm.LoadMe(object sender, EventArgs e)
    {
      ...
      ((UCEngineer) this.LoadedControl).CurrentEngineer = App.DB.Engineer.Engineer_Get(this.ID);
      this.LoadForm(RuntimeHelpers.GetObjectValue(sender), e, (IForm) this);
      ((UCEngineer) this.LoadedControl).SetupPostalRegionsDataGrid();
      ((UCEngineer) this.LoadedControl).SetupTrainingQualificationsDataGrid();
      ((UCEngineer) this.LoadedControl).SetupEngineerEquipmentDataGrid();
      ((UCEngineer) this.LoadedControl).SetupDisciplinariesDataGrid();
      ((UCEngineer) this.LoadedControl).SetupAbsenceDataGridGrid();
      ((UCEngineer) this.LoadedControl).SetupDgSiteSafetyAudit();
    }
    ...
    public int ID
    {
      ...
      set
      {
        ...
        if (this.ID == 0)
        {
          ...
          this.Text = "Engineer : Adding New...";
        }
        else
        {
          this.PageState = Enums.FormState.Update;
          this.Text = "Engineer : ID " + Conversions.ToString(this.ID);
        }
      }
    }
