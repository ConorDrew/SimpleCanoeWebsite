...
namespace FSM
{
  public class UCOrderRejection : UCBase, IUserControl
  {
    private IContainer components;

    public UCOrderRejection()
    {
    ...
    private void InitializeComponent()
    {
      ...
      this.grpMain.Size = new Size(633, 314);
      this.grpMain.TabIndex = 1;
      this.grpMain.TabStop = false;
      this.grpMain.Text = "Order Rejection Reason";
    ...
    public event UCOrderRejection.ReasonChangedEventHandler ReasonChanged;
    ...
    public delegate void ReasonChangedEventHandler(string reason);
  }
}
