...
namespace FSM
{
  public class FRMSupplier : FRMBaseForm, IForm
  {
    ...
    public FRMSupplier()
    {
      this.Load += new EventHandler(this.FRMSupplier_Load);
      this._ID = 0;
      this.InitializeComponent();
      this.TheLoadedControl = (IUserControl) new UCSupplier();
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = nameof (FRMSupplier);
      this.Text = "Supplier : ID {0}";
    ...
    void IForm.LoadMe(object sender, EventArgs e)
    {
      ...
      ((UCSupplier) this.LoadedControl).CurrentSupplier = App.DB.Supplier.Supplier_Get(this.ID);
    ...
    public int ID
    {
      ...
      set
      {
        ...
        if (this.ID == 0)
        {
          ...
          this.Text = "Supplier : Adding New...";
        }
        else
        {
          this.PageState = Enums.FormState.Update;
          this.Text = "Supplier : ID " + Conversions.ToString(this.ID);
        }
      }
    }
