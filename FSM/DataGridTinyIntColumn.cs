...
// Type: FSM.DataGridTinyIntColumn
...
namespace FSM
{
  public class DataGridTinyIntColumn : DataGridColumnStyle
  {
    ...
    public event DataGridTinyIntColumn.CheckedChangedEventHandler CheckedChanged;
    ...
    protected override bool Commit(CurrencyManager dataSource, int rowNum)
    {
      ...
      try
      {
        ...
        DataGridTinyIntColumn.CheckedChangedEventHandler checkedChangedEvent = this.CheckedChangedEvent;
      ...
      bool cellIsVisible)
    {
      ...
      {
        bool flag = Helper.MakeBooleanValid(RuntimeHelpers.GetObjectValue(this.GetColumnValueAtRow(source, rowNum)));
        if (cellIsVisible)
        {
