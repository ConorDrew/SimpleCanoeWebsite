...
// Type: FSM.FRMQuoteJobItemAssets
...
namespace FSM
{
  public class FRMQuoteJobItemAssets : FRMBaseForm, IForm
  {
    ...
    public FRMQuoteJobItemAssets()
    {
      this.Load += new EventHandler(this.FRMContract_Load);
      this._ID = 0;
      this.InitializeComponent();
      this.TheLoadedControl = (IUserControl) new UCQuoteJobItemAssets();
    ...
    private void InitializeComponent()
    {
      ...
      this.btnClose.Location = new System.Drawing.Point(8, 280);
      ...
      this.pnlMain.Size = new Size(600, 240);
      this.pnlMain.TabIndex = 1;
      this.AutoScaleBaseSize = new Size(6, 14);
      this.ClientSize = new Size(608, 318);
      this.Controls.Add((Control) this.btnClose);
      this.Controls.Add((Control) this.pnlMain);
      this.MaximizeBox = false;
      this.MinimizeBox = false;
      this.MinimumSize = new Size(400, 300);
      this.Name = "FRMJobItemAssets";
      this.Text = "Job Item Assets";
    ...
    void IForm.LoadMe(object sender, EventArgs e)
    {
      ...
      ((UCQuoteJobItemAssets) this.LoadedControl).IDToLinkTo = this.ID;
      this.LoadForm(RuntimeHelpers.GetObjectValue(sender), e, (IForm) this);
      ((UCQuoteJobItemAssets) this.LoadedControl).SetupAssetsDataGrid();
    }
