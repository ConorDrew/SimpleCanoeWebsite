...
namespace FSM
{
  public class UCQuoteJobItemAssets : UCBase, IUserControl
  {
    private IContainer components;
    private int _IDToLinkTo;
    private DataView _Assets;

    public UCQuoteJobItemAssets()
    {
    ...
    private void InitializeComponent()
    {
      ...
      this.grpAssets.Text = "Assets Included";
    ...
    public int IDToLinkTo
    {
      ...
      set
      {
        ...
        this.Assets = App.DB.QuoteContractAlternativeSiteAsset.GetAll_JobItemID(this.IDToLinkTo);
      }
    }
