...
// Type: FSM.FRMQuoteContractAlternativeSite
...
namespace FSM
{
  public class FRMQuoteContractAlternativeSite : FRMBaseForm, IForm
  {
    ...
    public FRMQuoteContractAlternativeSite()
    {
      this.Load += new EventHandler(this.FRMQuoteContractSite_Load);
      this._ID = 0;
      this._SiteID = 0;
      this.InitializeComponent();
      this.TheLoadedControl = (IUserControl) new UCQuoteContractAlternativeSite();
    ...
    private void InitializeComponent()
    {
      ...
      this.btnSave.Location = new System.Drawing.Point(8, 678);
      this.btnSave.Name = "btnSave";
      this.btnSave.Size = new Size(56, 25);
      this.btnSave.TabIndex = 2;
      this.btnSave.Text = "Save";
      this.btnClose.Anchor = AnchorStyles.Bottom | AnchorStyles.Left;
      this.btnClose.Location = new System.Drawing.Point(72, 678);
      ...
      this.pnlMain.Size = new Size(983, 638);
      this.pnlMain.TabIndex = 1;
      this.AutoScaleBaseSize = new Size(6, 14);
      this.ClientSize = new Size(991, 716);
      this.Controls.Add((Control) this.btnClose);
      this.Controls.Add((Control) this.btnSave);
      this.Controls.Add((Control) this.pnlMain);
      this.MaximizeBox = false;
      this.MinimizeBox = false;
      this.MinimumSize = new Size(999, 750);
      this.Name = nameof (FRMQuoteContractAlternativeSite);
    ...
    void IForm.LoadMe(object sender, EventArgs e)
    {
      ...
      this.CurrentQuoteContract = (QuoteContractAlternative) this.get_GetParameter(2);
      ((UCQuoteContractAlternativeSite) this.LoadedControl).SiteID = this.SiteID;
      ((UCQuoteContractAlternativeSite) this.LoadedControl).CurrentQuoteContract = this.CurrentQuoteContract;
      ((UCQuoteContractAlternativeSite) this.LoadedControl).CurrentQuoteContractSite = App.DB.QuoteContractAlternativeSite.Get(this.ID);
      ((UCQuoteContractAlternativeSite) this.LoadedControl).PopAssets();
      ((UCQuoteContractAlternativeSite) this.LoadedControl).SetupAssetsDataGrid();
      ((UCQuoteContractAlternativeSite) this.LoadedControl).SetupJobItemsDataGrid();
    ...
    public int ID
    {
      ...
      set
      {
        ...
        if (this.ID == 0)
        {
          ...
          this.Text = "Quote Contract Property : Adding New...";
        }
        else
        {
          this.PageState = Enums.FormState.Update;
          this.Text = "Quote Contract Property : ID " + Conversions.ToString(this.ID);
        }
      }
    }
