...
namespace FSM
{
  public class FRMPartsToBeCredited : FRMBaseForm, IForm
  {
    ...
    public FRMPartsToBeCredited()
    {
      this.Load += new EventHandler(this.FRMPartsToBeCredited_Load);
      this._ID = 0;
      this.InitializeComponent();
      this.TheLoadedControl = (IUserControl) new UCPartsToBeCredited();
    ...
    private void InitializeComponent()
    {
      ...
      this.btnClose.Location = new System.Drawing.Point(72, 203);
      ...
      this.pnlMain.Size = new Size(565, 163);
      this.pnlMain.TabIndex = 1;
      this.AutoScaleBaseSize = new Size(6, 14);
      this.ClientSize = new Size(576, 241);
      ...
      this.Name = "FRMAsset";
      this.Text = "Part To Be Credited : ID {0}";
    ...
    void IForm.LoadMe(object sender, EventArgs e)
    {
      ...
      ((UCPartsToBeCredited) this.LoadedControl).CurrentPartsToBeCredited = App.DB.PartsToBeCredited.PartsToBeCredited_Get(this.ID);
    ...
    public int ID
    {
      ...
      set
      {
        ...
        if (this.ID == 0)
        {
          ...
          this.Text = "Part To Be Credited : Adding New...";
        }
        else
        {
          this.PageState = Enums.FormState.Update;
          this.Text = "Part To Be Credited : ID " + Conversions.ToString(this.ID);
        }
      }
    }
    ...
    private void FRMPartsToBeCredited_Load(object sender, EventArgs e)
    {
