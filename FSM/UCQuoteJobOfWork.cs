...
namespace FSM
{
  public class UCQuoteJobOfWork : UCBase, IUserControl
  {
    ...
    private UCQuoteContractAlternativeSite _onControl;
    ...
    public UCQuoteJobOfWork()
    {
      this.Load += new EventHandler(this.UCJobOfWork_Load);
      this._onControl = (UCQuoteContractAlternativeSite) null;
    ...
    private void InitializeComponent()
    {
      ...
      this.grpScheduleOfRates.TabIndex = 3;
      this.grpScheduleOfRates.TabStop = false;
      this.grpScheduleOfRates.Text = "Property Contract Schedule Of Rates";
      this.btnSiteScheduleOfRates.Location = new System.Drawing.Point(96, 175);
      ...
      this.txtQuantityPerVisit.Size = new Size(72, 21);
      ...
      this.btnAddRates.Location = new System.Drawing.Point(8, 175);
      ...
      this.btnRemoveRates.Location = new System.Drawing.Point(352, 176);
      ...
      this.txtPrice.Size = new Size(72, 21);
      ...
      this.dgScheduleOfRates.Location = new System.Drawing.Point(8, 90);
      this.dgScheduleOfRates.Name = "dgScheduleOfRates";
      this.dgScheduleOfRates.Size = new Size(416, 82);
      ...
      this.txtItemTotal.Location = new System.Drawing.Point(344, 192);
      ...
      this.lblPricePerVisit.Location = new System.Drawing.Point(8, 288);
      this.lblPricePerVisit.Name = "lblPricePerVisit";
      this.lblPricePerVisit.Size = new Size(120, 20);
      this.lblPricePerVisit.TabIndex = 108;
      ...
      this.txtMileageCostPerVisit.Location = new System.Drawing.Point(344, 240);
      this.txtMileageCostPerVisit.Name = "txtMileageCostPerVisit";
      this.txtMileageCostPerVisit.Size = new Size(72, 21);
      this.txtMileageCostPerVisit.TabIndex = 9;
      this.txtMileageCostPerVisit.Text = "";
      this.txtAverageMileage.Location = new System.Drawing.Point(128, 216);
      ...
      this.btnRemoveFromJobOfWork.TabIndex = 1;
      ...
      this.dgVisits.Size = new Size(456, 80);
      ...
      this.dgJobItemsAdded.TabIndex = 2;
      ...
      this.dtpFirstVisitDate.Location = new System.Drawing.Point(104, 192);
      this.dtpFirstVisitDate.Name = "dtpFirstVisitDate";
      this.dtpFirstVisitDate.Size = new Size(96, 21);
      this.dtpFirstVisitDate.TabIndex = 4;
      ...
      this.lblFirstVisitDate.Location = new System.Drawing.Point(8, 192);
      this.lblFirstVisitDate.Name = "lblFirstVisitDate";
      this.lblFirstVisitDate.Size = new Size(96, 16);
      this.lblFirstVisitDate.TabIndex = 98;
      ...
      this.Name = nameof (UCQuoteJobOfWork);
      this.Size = new Size(896, 312);
    ...
    public event UCQuoteJobOfWork.RemovedItemEventHandler RemovedItem;
    ...
    public QuoteContractAlternativeSiteJobOfWork CurrentJobOfWork
    {
      ...
      set
      {
        ...
        this.txtCostPerMile.Text = Strings.Format((object) App.DB.CustomerCharge.CustomerCharge_GetForSite(this.OnControl.CurrentQuoteContractSite.SiteID).MileageRate, "C");
        ...
        this.Visits = App.DB.QuoteContractAlternativePPMVisits.GetAll_For_QuoteContractSiteJobOfWorkID(this._CurrentJobOfWork.QuoteContractSiteJobOfWorkID);
    ...
    private void btnRemoveFromJobOfWork_Click(object sender, EventArgs e)
    {
      if (this.SelectedJobItemsDataRow == null)
        return;
      App.DB.QuoteContractAlternativeSiteJobItems.Update(Conversions.ToInteger(this.SelectedJobItemsDataRow["QuoteContractSiteJobItemID"]), 0);
      this.CalculateItemTotal();
      // ISSUE: reference to a compiler-generated field
      UCQuoteJobOfWork.RemovedItemEventHandler removedItemEvent = this.RemovedItemEvent;
    ...
    {
      int siteId = this.OnControl.CurrentQuoteContractSite.SiteID;
    ...
    void IUserControl.Populate(int ID = 0)
    {
      ...
      this.ScheduleOfRatesDataview = App.DB.QuoteContractAlternativeSiteJobOfWork.GetJobOfWorkScheduleOfRates(this.CurrentJobOfWork.QuoteContractSiteJobOfWorkID);
      this.CalculateRates();
      this.CalculateMileageTotal();
      this.CalculateItemTotal();
      this.CalculateSiteTotal();
