...
namespace FSM
{
  public class FRMVan : FRMBaseForm, IForm
  {
    ...
    public FRMVan()
    {
      ...
      this.TheLoadedControl = (IUserControl) new UCVan();
    ...
    private void InitializeComponent()
    {
      ...
      this.btnSave.Location = new System.Drawing.Point(8, 680);
      this.btnSave.Name = "btnSave";
      this.btnSave.Size = new Size(56, 25);
      this.btnSave.TabIndex = 2;
      this.btnSave.Text = "Save";
      this.btnClose.Anchor = AnchorStyles.Bottom | AnchorStyles.Left;
      this.btnClose.Location = new System.Drawing.Point(72, 680);
      ...
      this.pnlMain.Size = new Size(685, 640);
      this.pnlMain.TabIndex = 1;
      this.AutoScaleBaseSize = new Size(6, 14);
      this.ClientSize = new Size(693, 718);
      this.Controls.Add((Control) this.btnClose);
      this.Controls.Add((Control) this.btnSave);
      this.Controls.Add((Control) this.pnlMain);
      this.MaximizeBox = false;
      this.MinimizeBox = false;
      this.MinimumSize = new Size(543, 570);
      this.Name = nameof (FRMVan);
      this.Text = "Van : ID {0}";
    ...
    void IForm.LoadMe(object sender, EventArgs e)
    {
      ...
      ((UCVan) this.LoadedControl).CurrentVan = App.DB.Van.Van_Get(this.ID);
      this.LoadForm(RuntimeHelpers.GetObjectValue(sender), e, (IForm) this);
      ((UCVan) this.LoadedControl).SetupPartsDatagrid();
      ((UCVan) this.LoadedControl).SetupProductsDatagrid();
      ((UCVan) this.LoadedControl).SetupWarehousesDatagrid();
      ((UCVan) this.LoadedControl).DgSetupVanEquipment();
    }
    ...
    public int ID
    {
      ...
      set
      {
        ...
        if (this.ID == 0)
        {
          ...
          this.Text = "Van : Adding New...";
        }
        else
        {
          this.PageState = Enums.FormState.Update;
          this.Text = "Van : ID " + Conversions.ToString(this.ID);
        }
      }
    }
