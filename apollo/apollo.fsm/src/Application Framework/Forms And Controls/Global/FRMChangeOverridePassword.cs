...
namespace FSM
{
    public class FRMChangeOverridePassword : FRMBaseForm, IForm
    {
        

        public FRMChangeOverridePassword() : base()
        {
        ...
        private void InitializeComponent()
        {
            ...
            this._btnUpdate.Location = new System.Drawing.Point(332, 178);
            ...
            this._grpNewDetails.Location = new System.Drawing.Point(4, 74);
            this._grpNewDetails.Name = "_grpNewDetails";
            this._grpNewDetails.Size = new System.Drawing.Size(384, 98);
            ...
            this._txtNewPassword.Size = new System.Drawing.Size(265, 21);
            ...
            this._txtConfirm.Size = new System.Drawing.Size(265, 21);
            ...
            this._grpCurrentDetails.Location = new System.Drawing.Point(4, 10);
            this._grpCurrentDetails.Name = "_grpCurrentDetails";
            this._grpCurrentDetails.Size = new System.Drawing.Size(384, 58);
            ...
            this._txtPassword.Size = new System.Drawing.Size(264, 21);
            ...
            this.Name = "FRMChangeOverridePassword";
            this.Text = "Override Password";
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!((Entity.Sys.Helper.HashPassword(txtPassword.Text.Trim()) ?? "") == (App.DB.Manager.Get().OverridePassword ?? "")))
                {
                ...
                if (valid)
                {
                    App.DB.Manager.UpdateOverridePassword(txtNewPassword.Text.Trim());
                    App.ShowMessage("Override Password Updated", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    txtPassword.Text = "";
                    txtNewPassword.Text = "";
                    txtConfirm.Text = "";
                }
