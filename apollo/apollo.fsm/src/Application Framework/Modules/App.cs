        ...
        public static Form ShowForm(Type frm, bool asDialgue, object[] parameters, bool IgnoreIfOpen = false)
        {
            try
            {
                ...
                if (newForm is null)
                {
                    ...
                    if (asDialgue)
                    {
                        if ((frm.Name.ToUpper() ?? "") != ("FRMAnswers".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMEngineerVisit".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMPostcodeManager".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMStockReplenishment".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMReceiveStock".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMPartsToOrders".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMAddToQuote".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMAddToOrder".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMOrderCharges".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMOrderAudit".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMEnterEmailAddress".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMChooseSupplierPacks".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMPickDespatchDetails".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMEngineerHistory".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMVanHistory".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMViewContractAlternativeChargeDetails".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMAvailableContractNos".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMChooseAsset".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMJobAudit".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMRaiseInvoiceDetails".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMConvertToAnOrder".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FrmInvoicedPayment".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMContractRenewal".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMSiteCustomerAudit".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMSitePopup".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMConsolidation".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMConsolidation_Location".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMConvertToPDF".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMSiteVisitManager".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMSiteLetterList".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMSelectLocation".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMCreditReceived".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMEngineerTimesheet".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMLastServiceDate".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMChangeInvoicedTotal".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMChangePaymentTerms".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMAmendServiceDate".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMChangeSageDate".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMJobWizard".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMAddInvoiceAddress".ToUpper() ?? "")
                            & (frm.Name.ToUpper() ?? "") != ("FRMChangeInvoiceLine".ToUpper() ?? "")
