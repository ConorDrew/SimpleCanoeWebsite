...
namespace FSM
{
    public class FRMEngineerVan : FRMBaseForm, IForm
    {
        ...
        public FRMEngineerVan() : base()
        {
            
            
            base.Load += FRMEngineerVan_Load;
        ...
        private void InitializeComponent()
        {
            ...
            this._btnSave.Location = new System.Drawing.Point(8, 176);
            ...
            this._btnClose.Location = new System.Drawing.Point(72, 176);
            ...
            this._pnlMain.Size = new System.Drawing.Size(616, 156);
            ...
            this.MaximumSize = new System.Drawing.Size(632, 248);
            this.MinimizeBox = false;
            this.MinimumSize = new System.Drawing.Size(632, 248);
            this.Name = "FRMEngineerVan";
        ...
        public void LoadMe(object sender, EventArgs e)
        {
            ...
            ((UCEngineerVan)LoadedControl).VanID = Entity.Sys.Helper.MakeIntegerValid(get_GetParameter(1));
            ((UCEngineerVan)LoadedControl).CurrentEngineerVan = App.DB.EngineerVan.EngineerVan_Get(ID);
        ...
        {
            ID = newID;
            ((FRMEngineerHistory)get_GetParameter(2)).VanHistory = App.DB.EngineerVan.EngineerVan_GetAll_For_Van(Entity.Sys.Helper.MakeIntegerValid(get_GetParameter(1)));
        }
        ...
        public int ID
        {
            ...
            set
            {
                ...
                if (ID == 0)
                {
                    ...
                    Text = "Engineer Van : Adding New...";
                }
                else
                {
                    PageState = Entity.Sys.Enums.FormState.Update;
                    Text = "Engineer Van : ID " + ID;
                }
            }
        }
