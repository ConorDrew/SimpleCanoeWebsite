...
namespace FSM
{
    public class FRMFleetEquipment : FRMBaseForm, IForm
    {
        ...
        public FRMFleetEquipment() : base()
        {
            ...
            TheLoadedControl = new UCFleetEquipment();
        ...
        private void InitializeComponent()
        {
            ...
            this._btnSave.Location = new System.Drawing.Point(8, 141);
            ...
            this._btnClose.Location = new System.Drawing.Point(72, 141);
            ...
            this._pnlMain.Size = new System.Drawing.Size(439, 123);
        ...
        public void LoadMe(object sender, EventArgs e)
        {
            ...
            ((UCFleetEquipment)LoadedControl).CurrentEquipment = App.DB.FleetEquipment.Get(ID);
        ...
        public int ID
        {
            ...
            set
            {
                ...
                if (ID == 0)
                {
                    ...
                    Text = "Equipment: Adding New...";
                }
                else
                {
                    PageState = Entity.Sys.Enums.FormState.Update;
                    Text = "Equipment: ID " + ID;
                }
            }
        }
