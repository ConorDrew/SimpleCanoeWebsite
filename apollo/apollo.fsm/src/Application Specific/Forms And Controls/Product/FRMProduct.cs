...
namespace FSM
{
    public class FRMProduct : FRMBaseForm, IForm
    {
        

        public FRMProduct() : base()
        {
            
            
            base.Load += FRMProduct_Load;
        ...
        private void InitializeComponent()
        {
            ...
            this._btnSave.Location = new System.Drawing.Point(8, 668);
            ...
            this._btnClose.Location = new System.Drawing.Point(72, 668);
            ...
            this._pnlMain.Size = new System.Drawing.Size(640, 648);
            ...
            this.MinimumSize = new System.Drawing.Size(656, 740);
            this.Name = "FRMProduct";
            this.Text = "Product : ID {0}";
        ...
        public void LoadMe(object sender, EventArgs e)
        {
            ...
            ((UCProduct)LoadedControl).CurrentProduct = App.DB.Product.Product_Get(ID);
            ((UCProduct)LoadedControl).FromOrder = Entity.Sys.Helper.MakeBooleanValid(get_GetParameter(1));
            LoadForm(sender, e, this);
            ((UCProduct)LoadedControl).SetupSuppliersDatagrid();
            ((UCProduct)LoadedControl).SetupAssociateDatagrid();
        }
