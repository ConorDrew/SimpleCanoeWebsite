Public Class FRMChangeOverridePassword : Inherits FSM.FRMBaseForm : Implements IForm
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "FRMChangeOverridePassword"
        Me.Text = "Override Password"
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        Try
            ...
            If Me.txtConfirm.Text.Trim.Length = 0 Then
                ...
                valid = False
            End If
            If Not (Entity.Sys.Helper.HashPassword(Me.txtPassword.Text.Trim) = DB.Manager.Get.OverridePassword) Then
            ...
            If valid Then
                DB.Manager.UpdateOverridePassword(Me.txtNewPassword.Text.Trim)
                ShowMessage("Override Password Updated", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Me.txtPassword.Text = ""
                Me.txtNewPassword.Text = ""
                Me.txtConfirm.Text = ""
            Else
