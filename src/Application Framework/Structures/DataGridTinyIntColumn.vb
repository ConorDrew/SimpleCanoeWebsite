Public Class DataGridTinyIntColumn
    ...
    ByVal cellIsVisible As Boolean)
        ...
        If Not IsDBNull(GetColumnValueAtRow([source], rowNum)) Then
            ...
            CType(Entity.Sys.Helper.MakeBooleanValid(GetColumnValueAtRow([source], rowNum)), Boolean)
    ...
    Protected Overloads Overrides Sub Paint(ByVal g As Graphics, ByVal bounds As Rectangle, ByVal [source] As CurrencyManager, ByVal rowNum As Integer, ByVal backBrush As Brush, ByVal foreBrush As Brush, ByVal alignToRight As Boolean)
        ...
        If IsDBNull(GetColumnValueAtRow([source], rowNum)) = False Then
            Dim checked As Boolean = CType(Entity.Sys.Helper.MakeBooleanValid(GetColumnValueAtRow([source], rowNum)), Boolean)
