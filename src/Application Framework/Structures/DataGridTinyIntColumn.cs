...
namespace FSM
{
    public class DataGridTinyIntColumn : DataGridColumnStyle
    {
...

        {
            ...
            {
                bool value = Entity.Sys.Helper.MakeBooleanValid(base.GetColumnValueAtRow(source, rowNum));
                if (cellIsVisible)
                {
        ...
        protected override void Paint(Graphics g, Rectangle bounds, CurrencyManager source, int rowNum, Brush backBrush, Brush foreBrush, bool alignToRight)
        {
            ...
            {
                bool @checked = Entity.Sys.Helper.MakeBooleanValid(base.GetColumnValueAtRow(source, rowNum));
