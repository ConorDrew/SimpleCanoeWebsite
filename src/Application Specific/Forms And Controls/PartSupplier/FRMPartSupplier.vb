Public Class FRMPartSupplier : Inherits FSM.FRMBaseForm : Implements IForm
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.btnSave.Location = New System.Drawing.Point(8, 194)
        ...
        Me.btnClose.Location = New System.Drawing.Point(72, 194)
        ...
        Me.pnlMain.Size = New System.Drawing.Size(600, 150)
        ...
        Me.MaximumSize = New System.Drawing.Size(615, 266)
        Me.MinimizeBox = False
        Me.MinimumSize = New System.Drawing.Size(615, 266)
        Me.Name = "FRMPartSupplier"
        Me.Text = "Part Supplier : ID {0}"
...
#Region "Interface Methods"
    ...
    Private Sub LoadMe(ByVal sender As Object, ByVal e As System.EventArgs) Implements IForm.LoadMe
        ...
        CType(LoadedControl, UCPartSupplier).PartID = Entity.Sys.Helper.MakeIntegerValid(GetParameter(1))
        CType(LoadedControl, UCPartSupplier).CurrentPartSupplier = DB.PartSupplier.PartSupplier_Get(ID)
    ...
    Public Sub ResetMe(ByVal newID As Integer) Implements IForm.ResetMe
        ID = newID
        CType(GetParameter(2), UCPart).PopulateSuppliers()
    End Sub
    ...
    Public Property ID() As Integer
        ...
        Set(ByVal Value As Integer)
            ...
            If ID = 0 Then
                ...
                Me.Text = "Part Supplier : Adding New..."
            Else
                PageState = Entity.Sys.Enums.FormState.Update
                Me.Text = "Part Supplier : ID " & ID
            End If
        End Set
    End Property
...
#Region "Events"
    ...
    Private Sub FRMPartSupplier_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LoadMe(sender, e)
    End Sub
