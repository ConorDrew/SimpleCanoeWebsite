Public Class FRMCustomer : Inherits FSM.FRMBaseForm : Implements IForm
...
#Region "Interface Methods"
    ...
    Private Sub LoadMe(ByVal sender As Object, ByVal e As System.EventArgs) Implements IForm.LoadMe
        ...
        CType(LoadedControl, UCCustomer).CurrentCustomer = DB.Customer.Customer_Get(ID)
        CType(LoadedControl, UCCustomer).SetupContractsDataGrid()
        CType(LoadedControl, UCCustomer).SetupPrioritiesDGV()
        CType(LoadedControl, UCCustomer).SetupRequirements()
        CType(LoadedControl, UCCustomer).SetupCustomerAuthorityAuditDataGrid()
        CType(LoadedControl, UCCustomer).SetupCustomerAlertsDataGrid()
    ...
    Public Property ID() As Integer
        ...
        Set(ByVal Value As Integer)
            ...
            If ID = 0 Then
                ...
                Me.Text = "Customer : Adding New..."
            Else
                PageState = Entity.Sys.Enums.FormState.Update
                Me.Text = "Customer : ID " & ID
            End If
        End Set
    End Property
