Public Class FRMQuoteContractOption3Site : Inherits FSM.FRMBaseForm : Implements IForm
...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New()
        ...
        TheLoadedControl = New UCQuoteContractOption3Site
...
#Region "Interface Methods"
    ...
    Private Sub LoadMe(ByVal sender As Object, ByVal e As System.EventArgs) Implements IForm.LoadMe
        ...
        CType(LoadedControl, UCQuoteContractOption3Site).CurrentQuoteContractOption3Site = DB.QuoteContractOption3Site.QuoteContractOption3Site_Get(ID)
        LoadForm(sender, e, Me)
        CType(LoadedControl, UCQuoteContractOption3Site).SetupAssetsDataGrid()
    End Sub
