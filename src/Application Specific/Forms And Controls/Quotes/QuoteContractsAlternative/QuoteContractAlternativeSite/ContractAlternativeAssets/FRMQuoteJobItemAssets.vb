Public Class FRMQuoteJobItemAssets : Inherits FSM.FRMBaseForm : Implements IForm
...
#Region "Interface Methods"
    ...
    Private Sub LoadMe(ByVal sender As Object, ByVal e As System.EventArgs) Implements IForm.LoadMe
        ...
        CType(LoadedControl, UCQuoteJobItemAssets).IDToLinkTo = ID
        LoadForm(sender, e, Me)
        CType(LoadedControl, UCQuoteJobItemAssets).SetupAssetsDataGrid()
    End Sub
