Public Class UCQuoteRejection : Inherits FSM.UCBase : Implements IUserControl
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents btnAdd As System.Windows.Forms.Button
        ...
        Me.grpMain.Size = New System.Drawing.Size(625, 266)
        Me.grpMain.TabIndex = 1
        Me.grpMain.TabStop = False
        Me.grpMain.Text = "Quote Rejection Reason"
        '
        'btnAdd
        '
        ...
        Me.txtReason.Anchor = CType((((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Bottom) _
                    Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.txtReason.Location = New System.Drawing.Point(136, 64)
        Me.txtReason.Multiline = True
        Me.txtReason.Name = "txtReason"
        Me.txtReason.ScrollBars = System.Windows.Forms.ScrollBars.Vertical
        Me.txtReason.Size = New System.Drawing.Size(480, 192)
        ...
        Me.cboPossibleReasons.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) _
                    Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.cboPossibleReasons.Location = New System.Drawing.Point(136, 33)
        Me.cboPossibleReasons.Name = "cboPossibleReasons"
        Me.cboPossibleReasons.Size = New System.Drawing.Size(424, 21)
        Me.cboPossibleReasons.TabIndex = 1
        '
        'UCQuoteRejection
        '
        Me.Controls.Add(Me.grpMain)
        Me.Name = "UCQuoteRejection"
        Me.Size = New System.Drawing.Size(640, 288)
...
#Region "Properties"
    ...
    Public Event ReasonChanged(ByVal reason As String, ByVal ReasonID As Integer)
...
#Region "Functions"
    ...
    Public Function Save() As Boolean Implements IUserControl.Save
        Try
            ...
            If txtReason.Text.Trim.Length > 0 Then
                RaiseEvent ReasonChanged(Me.txtReason.Text.Trim, Combo.GetSelectedItemValue(cboPossibleReasons))
                Return True
            Else
