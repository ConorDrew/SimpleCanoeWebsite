...
namespace FSM
{
    public class FRMQuoteJobSelectASite : FRMBaseForm, IForm
    {
        ...
        public void LoadMe(object sender, EventArgs e)
        {
            ...
            ((UCQuoteJobSelectASite)LoadedControl).Populate(ID);
            LoadForm(sender, e, this);
            ((UCQuoteJobSelectASite)LoadedControl).SetupSiteDataGrid();
        }
        ...
        private void SiteSelected(int SiteID)
        {
            ...
            {
                // FOR QUOTES
                ((UCQuotesList)get_GetParameter(1)).SelectedSiteID = SiteID;
            }
            catch (Exception ex)
            {
                // FOR CONTRACTS
                ((UCContractOriginal)((FRMContractOriginal)get_GetParameter(1)).LoadedControl).SiteID = SiteID;
            }
        }
