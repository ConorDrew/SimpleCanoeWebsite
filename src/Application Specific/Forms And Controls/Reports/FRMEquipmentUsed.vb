...
Public Class FRMEquipmentUsed : Inherits FSM.FRMBaseForm : Implements IForm
...
#Region "Setup"
    ...
    Private Sub SetupPartsUsedDataGrid()
        ...
        Dim Returned As New DataGridLabelColumn
        Returned.Format = "dd/MM/yyyy"
        Returned.FormatInfo = Nothing
...
#Region "Functions"
    ...
    Public Sub PopulateDatagrid()
        Try
            PartsDataview = DB.EngineerVisitsPartsAndProducts.Equipment_Used_Report(Format(dtpFrom.Value, "dd-MMM-yyyy") & " 00:00:00", Format(dtpTo.Value, "dd-MMM-yyyy") & " 23:59:59")
    ...
    Public Sub Export()
        ...
        For itm As Integer = 0 To CType(dgPartsUsed.DataSource, DataView).Count - 1
            ...
            r.Item("CollectedOnDate") = SelectedPartDataRow.Item("CollectedOnDate")
            dt.Rows.Add(r)
...
#End Region
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        ...
        If Not SelectedPartDataRow.Item("OrderReference") Is Nothing Then
            Try
                DB.ExecuteScalar("DELETE tblEquipmentCollected where EquipmentCollectedID = " & SelectedPartDataRow.Item("OrderReference"))
                ShowMessage("Deleted!", MessageBoxButtons.OK, MessageBoxIcon.Information)
                PopulateDatagrid()
            Catch
                ShowMessage("Error, See Rob", MessageBoxButtons.OK, MessageBoxIcon.Error)
            End Try
        Else

            ShowMessage("Please select a row", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End If
