Public Class UCJobItemAssets : Inherits FSM.UCBase : Implements IUserControl
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.grpAssets.Text = "Appliances Included"
        '
        'dgAssets
        '
...
#Region "Properties"
    ...
    Public Property IDToLinkTo() As Integer
        ...
        Set(ByVal Value As Integer)
            _IDToLinkTo = Value
            Assets = DB.ContractAlternativeSiteAsset.GetAll_JobItemID(IDToLinkTo)
        End Set
    End Property
