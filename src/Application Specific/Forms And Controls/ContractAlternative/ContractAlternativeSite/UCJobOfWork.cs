...
namespace FSM
{
    public class UCJobOfWork : UCBase, IUserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            _btnRemoveFromJobOfWork.TabIndex = 0;
            ...
            _dgVisits.Size = new Size(456, 88);
            _dgVisits.TabIndex = 46;
            // 
            // dgJobItemsAdded
            // 
            ...
            // Label5
            // 
            _Label5.Location = new Point(8, 223);
            _Label5.Name = "Label5";
            ...
            // Label4
            // 
            _Label4.Location = new Point(208, 223);
            _Label4.Name = "Label4";
            ...
            // Label2
            // 
            _Label2.Location = new Point(208, 247);
            _Label2.Name = "Label2";
            ...
            _txtMileageCostPerVisit.Location = new Point(344, 247);
            ...
            // txtAverageMileage
            // 
            _txtAverageMileage.Location = new Point(128, 223);
            ...
            // txtCostPerMile
            // 
            _txtCostPerMile.Location = new Point(344, 223);
            ...
            // chkIncludeMileage
            // 
            _chkIncludeMileage.Location = new Point(8, 247);
            ...
            // Label8
            // 
            _Label8.Location = new Point(208, 270);
            _Label8.Name = "Label8";
            ...
            _txtRatesTotal.Location = new Point(344, 271);
            ...
            // chkRates
            // 
            _chkRates.Location = new Point(8, 270);
            ...
            // Label6
            // 
            _Label6.Location = new Point(208, 294);
            _Label6.Name = "Label6";
            ...
            // txtTotalSitePrice
            // 
            _txtTotalSitePrice.Location = new Point(344, 295);
            ...
            // 
            _btnSiteScheduleOfRates.Location = new Point(96, 178);
            ...
            // btnAddRates
            // 
            _btnAddRates.Location = new Point(8, 178);
            ...
            _btnRemoveRates.Location = new Point(352, 180);
            ...
            _dgScheduleOfRates.Location = new Point(8, 91);
            _dgScheduleOfRates.Name = "dgScheduleOfRates";
            _dgScheduleOfRates.Size = new Size(416, 85);
            ...
            _txtPricePerVisit.Location = new Point(128, 295);
            ...
            _txtItemTotal.Location = new Point(344, 200);
        ...
        private UCContractAlternativeSite _onControl = null;
        ...
        private Entity.ContractAlternativeSiteJobOfWorks.ContractAlternativeSiteJobOfWork _CurrentJobOfWork;

        public Entity.ContractAlternativeSiteJobOfWorks.ContractAlternativeSiteJobOfWork CurrentJobOfWork
        {
            get
            {
            ...
            set
            {
                ...
                txtCostPerMile.Text = Strings.Format(App.DB.CustomerCharge.CustomerCharge_GetForCustomer(OnControl.CurrentContractSite.PropertyID).MileageRate, "C");
                txtPricePerVisit.Text = "£0.00";
                ScheduleOfRatesDataview = BuildUpScheduleOfRatesDataview();
                if (CurrentJobOfWork is null)
                {
                ...
                JobItemsAddedDataView = App.DB.ContractAlternativeSiteJobItems.GetAll_For_JobOfWorkID(CurrentJobOfWork.ContractSiteJobOfWorkID);
                Visits = App.DB.ContractAlternativePPMVisit.GetAll_For_ContractSiteJobOfWorkID(CurrentJobOfWork.ContractSiteJobOfWorkID);
        ...
        private void btnRemoveFromJobOfWork_Click(object sender, EventArgs e)
        {
            ...
            App.DB.ContractAlternativeSiteJobItems.Update(Conversions.ToInteger(SelectedJobItemsDataRow["ContractSiteJobItemID"]), 0);
            CalculateItemTotal();
            RemovedItem?.Invoke();
        }
        ...
        {
            if (dtpFirstVisitDate.Value < OnControl.CurrentContract.ContractStartDate | dtpFirstVisitDate.Value > OnControl.CurrentContract.ContractEndDate)
            {
        ...
        private void dgJobItemsAdded_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            if (SelectedJobItemsDataRow is object)
            {
                ...
                {
                    App.ShowForm(typeof(FRMJobItemAssets), true, new object[] { SelectedJobItemsDataRow["ContractSiteJobItemID"] });
                }
            }
        }
        ...
        private void btnSiteScheduleOfRates_Click(object sender, EventArgs e)
        {
            ...
            using (var f = new FRMSiteScheduleOfRateList(OnControl.CurrentContractSite.PropertyID, ref argDataviewToLinkToIn))
            {
                f.ShowDialog();
            }
        ...
        private void Populate(int ID = 0)
        {
            ...
            ScheduleOfRatesDataview = App.DB.ContractAlternativeSiteJobOfWork.GetJobOfWorkScheduleOfRates(CurrentJobOfWork.ContractSiteJobOfWorkID);
            CalculateRates();
            CalculateMileageTotal();
            CalculateItemTotal();
            CalculateSiteTotal();
