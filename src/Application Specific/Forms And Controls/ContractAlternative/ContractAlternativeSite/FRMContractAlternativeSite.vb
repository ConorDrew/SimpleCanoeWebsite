Public Class FRMContractAlternativeSite : Inherits FSM.FRMBaseForm : Implements IForm
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "FRMContractAlternativeSite"
...
#Region "Interface Methods"
    ...
    Private Sub LoadMe(ByVal sender As Object, ByVal e As System.EventArgs) Implements IForm.LoadMe
        ...
        CType(LoadedControl, UCContractAlternativeSite).SiteID = SiteID
        CType(LoadedControl, UCContractAlternativeSite).CurrentContract = CurrentContract
        CType(LoadedControl, UCContractAlternativeSite).CurrentContractSite = DB.ContractAlternativeSite.Get(ID)
        CType(LoadedControl, UCContractAlternativeSite).PopAssets()

        CType(LoadedControl, UCContractAlternativeSite).SetupAssetsDataGrid()
        CType(LoadedControl, UCContractAlternativeSite).SetupJobItemsDataGrid()
