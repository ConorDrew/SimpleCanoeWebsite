Public Class FRMFleetVanType : Inherits FSM.FRMBaseForm : Implements IForm
...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New()
        ...
        TheLoadedControl = New UCFleetVanType
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.btnSave.Location = New System.Drawing.Point(8, 182)
        ...
        Me.btnClose.Location = New System.Drawing.Point(72, 182)
        ...
        Me.pnlMain.Size = New System.Drawing.Size(580, 144)
...
#Region "Interface Methods"
    ...
    Private Sub LoadMe(ByVal sender As Object, ByVal e As System.EventArgs) Implements IForm.LoadMe
        ...
        CType(LoadedControl, UCFleetVanType).CurrentVanType = DB.FleetVanType.Get(ID)
    ...
    Public Property ID() As Integer
        ...
        Set(ByVal Value As Integer)
            ...
            If ID = 0 Then
                ...
                Me.Text = "Van Type: Adding New..."
            Else
                PageState = Entity.Sys.Enums.FormState.Update
                Me.Text = "Van Type: ID " & ID
            End If
        End Set
    End Property
