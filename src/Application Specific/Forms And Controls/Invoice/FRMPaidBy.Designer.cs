...
{
    [DesignerGenerated()]
    public partial class FRMPaidBy : Form
    {
        ...
        {
            var resources = new System.ComponentModel.ComponentResourceManager(typeof(FRMPaidBy));
            ...
            _cboDDPaid = new ComboBox();
            _GroupBox1.SuspendLayout();
            SuspendLayout();
            // 
            // GroupBox1
            // 
            _GroupBox1.Controls.Add(_cboDDPaid);
            ...
            _Label3.Location = new Point(130, 16);
            _Label3.Name = "Label3";
            _Label3.Size = new Size(262, 16);
            _Label3.TabIndex = 6;
            _Label3.Text = "Please indicate how the customer has paid";
            // 
            // btnOK
            // 
            ...
            // cboDDPaid
            // 
            _cboDDPaid.FormattingEnabled = true;
            _cboDDPaid.Location = new Point(146, 66);
            _cboDDPaid.Name = "cboDDPaid";
            _cboDDPaid.Size = new Size(213, 21);
            _cboDDPaid.TabIndex = 8;
            // 
            // FRMPaidBy
            // 
        ...
        private ComboBox _cboDDPaid;

        internal ComboBox cboDDPaid
        {
            [MethodImpl(MethodImplOptions.Synchronized)]
            get
            {
