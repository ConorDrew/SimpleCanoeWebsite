Public Class FRMContractOption3Site : Inherits FSM.FRMBaseForm : Implements IForm
...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New()
        ...
        TheLoadedControl = New UCContractOption3Site
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.pnlMain.Size = New System.Drawing.Size(994, 616)
        Me.pnlMain.TabIndex = 1
        '
        'FRMContractOption3Site
        '
        ...
        Me.MinimumSize = New System.Drawing.Size(1010, 728)
        Me.Name = "FRMContractOption3Site"
        Me.Text = "Contract Option3 Property : ID {0}"
...
#Region "Interface Methods"
    ...
    Private Sub LoadMe(ByVal sender As Object, ByVal e As System.EventArgs) Implements IForm.LoadMe
        ...
        CType(LoadedControl, UCContractOption3Site).SetupAssetsDataGrid()
        CType(LoadedControl, UCContractOption3Site).SetupPPMDataGrid()
        CType(LoadedControl, UCContractOption3Site).SetupInvoiceAddressDataGrid()
        ID = Entity.Sys.Helper.MakeIntegerValid(GetParameter(0))
        CType(LoadedControl, UCContractOption3Site).CurrentContractOption3Site = DB.ContractOption3Site.ContractOption3Site_Get(ID)
...
#Region "Events"
    ...
    Private Sub FRMContractOption3Site_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LoadMe(sender, e)
    End Sub
