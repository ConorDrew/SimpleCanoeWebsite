...
namespace FSM
{
    public class FRMContractOption3Site : FRMBaseForm, IForm
    {

        /* TODO ERROR: Skipped RegionDirectiveTrivia */
        public FRMContractOption3Site() : base()
        {

            /* TODO ERROR: Skipped EndRegionDirectiveTrivia */
            /* TODO ERROR: Skipped RegionDirectiveTrivia */
            base.Load += FRMContractOption3Site_Load;
        ...
        private void InitializeComponent()
        {
            ...
            _pnlMain.Size = new Size(994, 616);
            _pnlMain.TabIndex = 1;
            // 
            // FRMContractOption3Site
            // 
            AutoScaleBaseSize = new Size(6, 14);
            ClientSize = new Size(1002, 694);
            Controls.Add(_btnClose);
            Controls.Add(_btnSave);
            Controls.Add(_pnlMain);
            MaximizeBox = false;
            MinimizeBox = false;
            MinimumSize = new Size(1010, 728);
            Name = "FRMContractOption3Site";
            Text = "Contract Option3 Property : ID {0}";
        ...
        private void LoadMe(object sender, EventArgs e)
        {
            ...
            ((UCContractOption3Site)LoadedControl).SetupAssetsDataGrid();
            ((UCContractOption3Site)LoadedControl).SetupPPMDataGrid();
            ((UCContractOption3Site)LoadedControl).SetupInvoiceAddressDataGrid();
            ID = Entity.Sys.Helper.MakeIntegerValid(get_GetParameter(0));
            ((UCContractOption3Site)LoadedControl).CurrentContractOption3Site = App.DB.ContractOption3Site.ContractOption3Site_Get(ID);
        }
