...
namespace FSM
{
    public class FRMPartsToBeCredited : FRMBaseForm, IForm
    {
        ...
        public FRMPartsToBeCredited() : base()
        {
            
            
            base.Load += FRMPartsToBeCredited_Load;
            ...
            TheLoadedControl = new UCPartsToBeCredited();
        ...
        private void InitializeComponent()
        {
            ...
            this._btnSave.Location = new System.Drawing.Point(8, 203);
            ...
            this._btnClose.Location = new System.Drawing.Point(72, 203);
            ...
            this._pnlMain.Size = new System.Drawing.Size(565, 186);
            this._pnlMain.TabIndex = 1;
            // 
            // FRMPartsToBeCredited
            // 
            ...
            this.Name = "FRMPartsToBeCredited";
        ...
        public void LoadMe(object sender, EventArgs e)
        {
            ...
            ((UCPartsToBeCredited)LoadedControl).CurrentPartsToBeCredited = App.DB.PartsToBeCredited.PartsToBeCredited_Get(ID);
        ...
        public int ID
        {
            ...
            set
            {
                ...
                if (ID == 0)
                {
                    ...
                    Text = "Part To Be Credited : Adding New...";
                }
                else
                {
                    PageState = Entity.Sys.Enums.FormState.Update;
                    Text = "Part To Be Credited : ID " + ID;
                }
            }
        }
