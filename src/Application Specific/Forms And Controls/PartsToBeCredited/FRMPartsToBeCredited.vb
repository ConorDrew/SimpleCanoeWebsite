Public Class FRMPartsToBeCredited : Inherits FSM.FRMBaseForm : Implements IForm
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.btnSave.Location = New System.Drawing.Point(8, 203)
        ...
        Me.btnClose.Location = New System.Drawing.Point(72, 203)
        ...
        Me.pnlMain.Size = New System.Drawing.Size(565, 163)
        ...
        Me.Name = "FRMAsset"
        Me.Text = "Part To Be Credited : ID {0}"
...
#Region "Interface Methods"
    ...
    Private Sub LoadMe(ByVal sender As Object, ByVal e As System.EventArgs) Implements IForm.LoadMe
        ...
        CType(LoadedControl, UCPartsToBeCredited).CurrentPartsToBeCredited = DB.PartsToBeCredited.PartsToBeCredited_Get(ID)
    ...
    Public Property ID() As Integer
        ...
        Set(ByVal Value As Integer)
            ...
            If ID = 0 Then
                ...
                Me.Text = "Part To Be Credited : Adding New..."
            Else
                PageState = Entity.Sys.Enums.FormState.Update

                Me.Text = "Part To Be Credited : ID " & ID
...
#Region "Events"
    ...
    Private Sub FRMPartsToBeCredited_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LoadMe(sender, e)
    End Sub
