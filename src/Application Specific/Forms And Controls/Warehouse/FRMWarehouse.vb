Public Class FRMWarehouse : Inherits FSM.FRMBaseForm : Implements IForm
...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New()
        ...
        TheLoadedControl = New UCWarehouse
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.btnSave.Location = New System.Drawing.Point(8, 532)
        ...
        Me.btnClose.Location = New System.Drawing.Point(72, 532)
        ...
        Me.pnlMain.Size = New System.Drawing.Size(641, 491)
        ...
        Me.MinimumSize = New System.Drawing.Size(656, 604)
        Me.Name = "FRMWarehouse"
        Me.Text = "Warehouse : ID {0}"
...
#Region "Interface Methods"
    ...
    Private Sub LoadMe(ByVal sender As Object, ByVal e As System.EventArgs) Implements IForm.LoadMe
        ...
        CType(LoadedControl, UCWarehouse).CurrentWarehouse = DB.Warehouse.Warehouse_Get(ID)
        LoadForm(sender, e, Me)
        CType(LoadedControl, UCWarehouse).SetupPartsDatagrid()
        CType(LoadedControl, UCWarehouse).SetupProductsDatagrid()
        CType(LoadedControl, UCWarehouse).SetupVansDatagrid()
    End Sub
    ...
    Public Property ID() As Integer
        ...
        Set(ByVal Value As Integer)
            ...
            If ID = 0 Then
                ...
                Me.Text = "Warehouse : Adding New..."
            Else
                PageState = Entity.Sys.Enums.FormState.Update
                Me.Text = "Warehouse : ID " & ID
            End If
        End Set
    End Property
...
#Region "Events"
    ...
    Private Sub FRMWarehouse_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LoadMe(sender, e)
    End Sub
