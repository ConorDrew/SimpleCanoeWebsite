Public Class FRMProduct : Inherits FSM.FRMBaseForm : Implements IForm
...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New()
        ...
        TheLoadedControl = New UCProduct
...
#Region "Interface Methods"
    ...
    Private Sub LoadMe(ByVal sender As Object, ByVal e As System.EventArgs) Implements IForm.LoadMe
        ...
        CType(LoadedControl, UCProduct).CurrentProduct = DB.Product.Product_Get(ID)
        CType(LoadedControl, UCProduct).FromOrder = Entity.Sys.Helper.MakeBooleanValid(GetParameter(1))
        LoadForm(sender, e, Me)
        CType(LoadedControl, UCProduct).SetupSuppliersDatagrid()
        CType(LoadedControl, UCProduct).SetupAssociateDatagrid()
    End Sub
    ...
    Public Property ID() As Integer
        ...
        Set(ByVal Value As Integer)
            ...
            If ID = 0 Then
                ...
                Me.Text = "Product : Adding New..."
            Else
                PageState = Entity.Sys.Enums.FormState.Update
                Me.Text = "Product : ID " & ID
            End If
        End Set
    End Property
