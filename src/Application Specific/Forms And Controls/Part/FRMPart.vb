Public Class FRMPart : Inherits FSM.FRMBaseForm : Implements IForm
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.btnSave.Location = New System.Drawing.Point(8, 668)
        ...
        Me.btnClose.Location = New System.Drawing.Point(72, 668)
        ...
        Me.pnlMain.Size = New System.Drawing.Size(640, 628)
        ...
        Me.MinimumSize = New System.Drawing.Size(656, 740)
        Me.Name = "FRMPart"
        Me.Text = "Part : ID {0}"
...
#Region "Interface Methods"
    ...
    Private Sub LoadMe(ByVal sender As Object, ByVal e As System.EventArgs) Implements IForm.LoadMe
        ...
        UseOverride = GetParameter(1)
        CType(LoadedControl, UCPart).FromOrder = Entity.Sys.Helper.MakeBooleanValid(GetParameter(1))

        CType(LoadedControl, UCPart).CurrentPart = DB.Part.Part_Get(ID)
        LoadForm(sender, e, Me)

        CType(LoadedControl, UCPart).SetupSuppliersDatagrid()
        CType(LoadedControl, UCPart).SetupStockDatagrid()
        CType(LoadedControl, UCPart).SetupQuantityDatagrid()
    End Sub
...
#Region "Properties"
    ...
    Private _UseOverride As Boolean = True
