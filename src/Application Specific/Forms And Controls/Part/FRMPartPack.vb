Public Class FRMPartPack : Inherits FSM.FRMBaseForm : Implements IForm
...
#Region "Interface Methods"
    ...
    Private Sub LoadMe(ByVal sender As Object, ByVal e As System.EventArgs) Implements IForm.LoadMe
        ...
        CType(LoadedControl, UCPartPack).PackID = (ID)

        Dim populate As Boolean = Entity.Sys.Helper.MakeBooleanValid(GetParameter(2))
        If populate Then
            CType(LoadedControl, UCPartPack).Populate(ID)
            CType(LoadedControl, UCPartPack).btnAdd.Visible = False
            CType(LoadedControl, UCPartPack).btnRemove.Visible = False
    ...
    Public Property ID() As Integer
        ...
        Set(ByVal Value As Integer)
            ...
            If ID = 0 Then
                ...
                Me.Text = "PartPack : Adding New..."
            Else
                PageState = Entity.Sys.Enums.FormState.Update
                Me.Text = "PartPack : ID " & ID
            End If
        End Set
    End Property
