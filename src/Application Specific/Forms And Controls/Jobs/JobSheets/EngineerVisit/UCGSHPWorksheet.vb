...
Public Class UCGSHPWorksheet : Inherits FSM.UCBase : Implements IUserControl
...
#End Region
    ...
    Public Function Save() As Boolean Implements IUserControl.Save
        Try
            ...
            Worksheet.SetReading = CInt(Enums.WorksheetFuelTypes.GSHP)
            ...
            Dim dValidator As New EngineerVisitAssetWorkSheetValidatorGSHP
