...
namespace FSM
{
    ...
    {
        public UCGSHPWorksheet(EngineerVisitAssetWorkSheet worksheet, int jobID, Entity.EngineerVisits.EngineerVisit EngineerVisit) : base()
        {
        ...
        public void Populate(int ID = 0)
        {
            ...
            var argcombo2 = cboPressureTest;
            Combo.SetSelectedComboItem_By_Value(ref argcombo2, Worksheet.FlueFlowTestID.ToString());
            var argcombo3 = cboOperation;
            Combo.SetSelectedComboItem_By_Value(ref argcombo3, Worksheet.SpillageTestID.ToString());
            var argcombo4 = cboSafetyDevices;
            Combo.SetSelectedComboItem_By_Value(ref argcombo4, Worksheet.FlueTerminationSatisfactoryID.ToString());
            var argcombo5 = cboStability;
            Combo.SetSelectedComboItem_By_Value(ref argcombo5, Worksheet.VisualConditionOfFlueSatisfactoryID.ToString());
            var argcombo6 = cboVentilation;
            Combo.SetSelectedComboItem_By_Value(ref argcombo6, Worksheet.VentilationProvisionSatisfactoryID.ToString());
            var argcombo7 = cboSafetyDeviceOperation;
            Combo.SetSelectedComboItem_By_Value(ref argcombo7, Worksheet.SafetyDeviceOperationID.ToString());
            var argcombo8 = cboLegionella;
            Combo.SetSelectedComboItem_By_Value(ref argcombo8, Worksheet.SweepOutcomeID.ToString());
            var argcombo9 = cboCondition;
            Combo.SetSelectedComboItem_By_Value(ref argcombo9, Worksheet.OverallID.ToString());
            var argcombo10 = cboGlycol;
            Combo.SetSelectedComboItem_By_Value(ref argcombo10, Worksheet.DischargeID.ToString());
            var argcombo11 = cboServiced;
            Combo.SetSelectedComboItem_By_Value(ref argcombo11, Worksheet.ApplianceServiceOrInspectedID.ToString());
            var argcombo12 = cboSafety;
            Combo.SetSelectedComboItem_By_Value(ref argcombo12, Worksheet.ApplianceSafeID.ToString());
        }
        ...
        public bool Save()
        {
            try
            {
                ...
                Worksheet.SetReading = Conversions.ToInteger(Enums.WorksheetFuelTypes.GSHP);
                ...
                var dValidator = new EngineerVisitAssetWorkSheetValidatorGSHP();
