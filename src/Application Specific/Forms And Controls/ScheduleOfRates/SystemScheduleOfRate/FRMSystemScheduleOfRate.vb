Public Class FRMSystemScheduleOfRate : Inherits FSM.FRMBaseForm : Implements IForm
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Name = "FRMSystemScheduleOfRate"
...
#Region "Interface Methods"
    ...
    Private Sub LoadMe(ByVal sender As Object, ByVal e As System.EventArgs) Implements IForm.LoadMe
        ...
        CType(TheLoadedControl, UCSystemScheduleOfRate).SetupRatesDataGrid()
        CType(TheLoadedControl, UCSystemScheduleOfRate).SetupEngineerQualDataGrid()
        CType(TheLoadedControl, UCSystemScheduleOfRate).Populate()
...
#Region "Properties"
    ...
    Public Property ID() As Integer
        ...
        Set(ByVal Value As Integer)
            _ID = Value
            Me.Text = "System Schedule Of Rates"
        End Set
    End Property
