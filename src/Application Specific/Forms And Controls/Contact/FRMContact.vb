Public Class FRMContact : Inherits FSM.FRMBaseForm : Implements IForm
...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New()
        ...
        TheLoadedControl = New UCContact
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.btnClose.Location = New System.Drawing.Point(72, 571)
        ...
        Me.pnlMain.Size = New System.Drawing.Size(688, 531)
        Me.pnlMain.TabIndex = 1
        '
        'FRMContact
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(6, 14)
        Me.ClientSize = New System.Drawing.Size(696, 609)
        Me.Controls.Add(Me.btnClose)
        Me.Controls.Add(Me.btnSave)
        Me.Controls.Add(Me.pnlMain)
        Me.MaximizeBox = False
        Me.MinimizeBox = False
        Me.MinimumSize = New System.Drawing.Size(546, 579)
        Me.Name = "FRMContact"
        Me.Text = "Contact : ID {0}"
...
#Region "Interface Methods"
    ...
    Private Sub LoadMe(ByVal sender As Object, ByVal e As System.EventArgs) Implements IForm.LoadMe
        ...
        CType(LoadedControl, UCContact).SiteID = Entity.Sys.Helper.MakeIntegerValid(GetParameter(1))
        CType(LoadedControl, UCContact).CurrentContact = DB.Contact.Contact_Get(ID)
        LoadForm(sender, e, Me)
        CType(LoadedControl, UCContact).SetupNotesDataGrid()
    End Sub
    ...
    Public Sub ResetMe(ByVal newID As Integer) Implements IForm.ResetMe
        ID = newID
        CType(GetParameter(2), UCSite).PopulateContacts()
    End Sub
    ...
    Public Property ID() As Integer
        ...
        Set(ByVal Value As Integer)
            ...
            If ID = 0 Then
                ...
                Me.Text = "Contact : Adding New..."
            Else
                PageState = Entity.Sys.Enums.FormState.Update
                Me.Text = "Contact : ID " & ID
            End If
        End Set
    End Property
...
#Region "Events"
    ...
    Private Sub FRMContact_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LoadMe(sender, e)
    End Sub
