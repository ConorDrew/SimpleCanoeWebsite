...
namespace FSM
{
    public class FRMContact : FRMBaseForm, IForm
    {
        ...
        public FRMContact() : base()
        {
            
            
            base.Load += FRMContact_Load;
        ...
        private void InitializeComponent()
        {
            ...
            this._btnSave.Location = new System.Drawing.Point(8, 571);
            ...
            this._btnClose.Location = new System.Drawing.Point(72, 571);
            ...
            this._pnlMain.Size = new System.Drawing.Size(688, 551);
            ...
            this.MinimumSize = new System.Drawing.Size(546, 579);
        ...
        public void LoadMe(object sender, EventArgs e)
        {
            ...
            ((UCContact)LoadedControl).SiteID = Entity.Sys.Helper.MakeIntegerValid(get_GetParameter(1));
            ((UCContact)LoadedControl).CurrentContact = App.DB.Contact.Contact_Get(ID);
            LoadForm(sender, e, this);
            ((UCContact)LoadedControl).SetupNotesDataGrid();
        }
        ...
        {
            ID = newID;
            ((UCSite)get_GetParameter(2)).PopulateContacts();
        }
