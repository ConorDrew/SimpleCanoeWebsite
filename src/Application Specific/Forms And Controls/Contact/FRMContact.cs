...
namespace FSM
{
    public class FRMContact : FRMBaseForm, IForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            _btnSave.Location = new Point(8, 571);
            ...
            _btnClose.Location = new Point(72, 571);
            ...
            _pnlMain.Size = new Size(688, 531);
            _pnlMain.TabIndex = 1;
            //
            // FRMContact
            //
            AutoScaleBaseSize = new Size(6, 14);
            ClientSize = new Size(696, 609);
            Controls.Add(_btnClose);
            Controls.Add(_btnSave);
            Controls.Add(_pnlMain);
            MaximizeBox = false;
            MinimizeBox = false;
            MinimumSize = new Size(546, 579);
            Name = "FRMContact";
            Text = "Contact : ID {0}";
