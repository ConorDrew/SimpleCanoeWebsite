Public Class FRMEngineerHistory : Inherits FSM.FRMBaseForm : Implements IForm
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.grpHistory.Controls.Add(Me.btnAdd)
        ...
        Me.grpHistory.Text = "Double Click To View / Edit"
        '
        'btnAdd
        '
        ...
        Me.dgHistory.Location = New System.Drawing.Point(8, 26)
        Me.dgHistory.Name = "dgHistory"
        Me.dgHistory.Size = New System.Drawing.Size(840, 374)
        ...
        Me.Name = "FRMEngineerHistory"
        Me.Text = "Engineer History For Profile : {0}"
...
#Region "Properties"
    ...
    Private _Van As Entity.Vans.Van = Nothing
    Public Property Van() As Entity.Vans.Van
        ...
        Set(ByVal Value As Entity.Vans.Van)
            _Van = Value
            Me.Text = "Engineer History For Profile : " & Van.Registration
            VanHistory = DB.EngineerVan.EngineerVan_GetAll_For_Van(Van.VanID)
        End Set
    End Property
...
#Region "Events"
    ...
    Private Sub FRMEngineerHistory_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LoadMe(sender, e)
    End Sub

    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        ShowForm(GetType(FRMEngineerVan), True, New Object() {0, Van.VanID, Me})
        VanHistory = DB.EngineerVan.EngineerVan_GetAll_For_Van(Van.VanID)
    End Sub

    Private Sub dgHistory_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgHistory.DoubleClick
        If SelectedHistoryDataRow Is Nothing Then
            Exit Sub
        End If

        ShowForm(GetType(FRMEngineerVan), True, New Object() {SelectedHistoryDataRow.Item("EngineerVanID"), Van.VanID, Me})
        VanHistory = DB.EngineerVan.EngineerVan_GetAll_For_Van(Van.VanID)
    End Sub
