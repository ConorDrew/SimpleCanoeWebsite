...
namespace FSM
{
    public class FRMEngineerVan : FRMBaseForm, IForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            _btnSave.Location = new Point(8, 176);
            ...
            _btnClose.Location = new Point(72, 176);
            ...
            _pnlMain.Size = new Size(616, 136);
            _pnlMain.TabIndex = 1;
            // 
            // FRMEngineerVan
            // 
            AutoScaleBaseSize = new Size(6, 14);
            ClientSize = new Size(624, 214);
            Controls.Add(_btnClose);
            Controls.Add(_btnSave);
            Controls.Add(_pnlMain);
            MaximizeBox = false;
            MaximumSize = new Size(632, 248);
            MinimizeBox = false;
            MinimumSize = new Size(632, 248);
            Name = "FRMEngineerVan";
            Text = "Engineer profile : ID {0}";
