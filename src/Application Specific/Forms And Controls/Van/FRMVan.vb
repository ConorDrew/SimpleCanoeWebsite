Public Class FRMVan : Inherits FSM.FRMBaseForm : Implements IForm
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.btnSave.Location = New System.Drawing.Point(8, 680)
        ...
        Me.btnClose.Location = New System.Drawing.Point(72, 680)
        ...
        Me.pnlMain.Size = New System.Drawing.Size(685, 640)
        Me.pnlMain.TabIndex = 1
        '
        'FRMVan
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(6, 14)
        Me.ClientSize = New System.Drawing.Size(693, 718)
...
#Region "Interface Methods"
    ...
    Private Sub LoadMe(ByVal sender As Object, ByVal e As System.EventArgs) Implements IForm.LoadMe
        ...
        CType(LoadedControl, UCVan).CurrentVan = DB.Van.Van_Get(ID)
        LoadForm(sender, e, Me)
        CType(LoadedControl, UCVan).SetupPartsDatagrid()
        CType(LoadedControl, UCVan).SetupProductsDatagrid()
        CType(LoadedControl, UCVan).SetupWarehousesDatagrid()
        CType(LoadedControl, UCVan).DgSetupVanEquipment()
    End Sub
