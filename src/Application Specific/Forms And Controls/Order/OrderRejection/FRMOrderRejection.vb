Public Class FRMOrderRejection : Inherits FSM.FRMBaseForm : Implements IForm
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.pnlMain.Size = New System.Drawing.Size(640, 288)
        ...
        Me.MinimumSize = New System.Drawing.Size(656, 400)
        Me.Name = "FRMOrderRejection"
...
#Region "Interface Methods"
    ...
    Private Sub LoadMe(ByVal sender As Object, ByVal e As System.EventArgs) Implements IForm.LoadMe
        AddHandler CType(TheLoadedControl, UCOrderRejection).ReasonChanged, AddressOf ReasonChanged
        Reason = Entity.Sys.Helper.MakeStringValid(GetParameter(1))
        Approval = Entity.Sys.Helper.MakeBooleanValid(GetParameter(2))
...
#Region "Properties"
    ...
    Public Event ReasonEdited(ByVal reason As String)
    ...
    Public Property Reason() As String
        ...
        Set(ByVal Value As String)
            ...
            Else
                ...
                CType(TheLoadedControl, UCOrderRejection).txtReason.Text = Reason
            End If
        End Set
    End Property
    ...
    Public Property Approval() As Boolean
        ...
        Set(ByVal value As Boolean)
            _approval = value
            If _approval Then
                Me.Text = "Add Reason for Approval"
                CType(TheLoadedControl, UCOrderRejection).grpMain.Text = "Order Approval Reason"
            End If
        End Set
    End Property
...
#Region "Events"
    ...
    Private Sub FRMOrderRejection_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LoadMe(sender, e)
    End Sub

    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If LoadedControl.Save() Then
            ReasonChanged(CType(TheLoadedControl, UCOrderRejection).txtReason.Text.Trim)
            If Me.Modal Then
                Me.Close()
            Else
                Me.Dispose()
    ...
    Public Sub ReasonChanged(ByVal reason As String)
        RaiseEvent ReasonEdited(reason)
    End Sub
