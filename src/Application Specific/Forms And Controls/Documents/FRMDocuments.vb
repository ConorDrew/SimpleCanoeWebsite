Public Class FRMDocuments : Inherits FSM.FRMBaseForm : Implements IForm
...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New()
        ...
        TheLoadedControl = New UCDocuments
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.btnSave.Location = New System.Drawing.Point(8, 533)
        ...
        Me.btnClose.Location = New System.Drawing.Point(72, 533)
        ...
        Me.pnlMain.Size = New System.Drawing.Size(640, 493)
        ...
        Me.MinimumSize = New System.Drawing.Size(656, 605)
        Me.Name = "FRMDocuments"
        Me.Text = "Document : ID {0}"
...
#Region "Interface Methods"
    ...
    Private Sub LoadMe(ByVal sender As Object, ByVal e As System.EventArgs) Implements IForm.LoadMe
        CType(LoadedControl, UCDocuments).EntityToLinkTo = GetParameter(0)
        CType(LoadedControl, UCDocuments).IDToLinkTo = Entity.Sys.Helper.MakeIntegerValid(GetParameter(1))
        ID = Entity.Sys.Helper.MakeIntegerValid(GetParameter(2))
        CType(LoadedControl, UCDocuments).CurrentDocuments = DB.Documents.Documents_Get(ID)
    ...
    Public Sub ResetMe(ByVal newID As Integer) Implements IForm.ResetMe
        ...
        Try
            CType(GetParameter(3), UCDocumentsList).IDToLinkTo = Entity.Sys.Helper.MakeIntegerValid(GetParameter(1))
    ...
    Public Property ID() As Integer
        ...
        Set(ByVal Value As Integer)
            ...
            If ID = 0 Then
                ...
                Me.Text = "Document : Adding New..."
            Else
                PageState = Entity.Sys.Enums.FormState.Update
                Me.Text = "Document : ID " & ID
            End If
        End Set
    End Property
...
#Region "Events"
    ...
    Private Sub FRMDocuments_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LoadMe(sender, e)
    End Sub
