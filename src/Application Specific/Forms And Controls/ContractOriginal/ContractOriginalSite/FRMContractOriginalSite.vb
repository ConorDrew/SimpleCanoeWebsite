Public Class FRMContractOriginalSite : Inherits FSM.FRMBaseForm : Implements IForm
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.pnlMain.Size = New System.Drawing.Size(942, 616)
        ...
        Me.MinimumSize = New System.Drawing.Size(958, 728)
        Me.Name = "FRMContractOriginalSite"
        Me.Text = "Contract Property : ID {0}"
...
#Region "Interface Methods"
    ...
    Private Sub LoadMe(ByVal sender As Object, ByVal e As System.EventArgs) Implements IForm.LoadMe
        ...
        CurrentContract = GetParameter(2)

        Try
            OldContractSiteID = Entity.Sys.Helper.MakeIntegerValid(GetParameter(4))
        Catch ex As Exception
            'do nothing
        End Try

        CType(LoadedControl, UCContractOriginalSite).SiteID = SiteID
        CType(LoadedControl, UCContractOriginalSite).CurrentContract = CurrentContract
        CType(LoadedControl, UCContractOriginalSite).OldContractSite = DB.ContractOriginalSite.Get(OldContractSiteID)
        CType(LoadedControl, UCContractOriginalSite).CurrentContractSite = DB.ContractOriginalSite.Get(ID)
        CType(LoadedControl, UCContractOriginalSite).PopAssets()

        LoadForm(sender, e, Me)
        CType(LoadedControl, UCContractOriginalSite).SetupAssetsDataGrid()
        CType(LoadedControl, UCContractOriginalSite).SetupVisitDataGrid()
        CType(LoadedControl, UCContractOriginalSite).SetupVisit2DataGrid()
        CType(LoadedControl, UCContractOriginalSite).SetupScheduleOfRatesDataGrid()
        CType(LoadedControl, UCContractOriginalSite).SetupSystemRatesDataGrid()
...
#Region "Properties"
    ...
    Public Property ID() As Integer
        ...
        Set(ByVal Value As Integer)
            ...
            If ID = 0 Then
                ...
                Me.Text = "Contract Property : Adding New..."
            Else
                PageState = Entity.Sys.Enums.FormState.Update
                Me.Text = "Contract Property : ID " & ID
            End If
        End Set
    End Property
    ...
    Private _OldContractSiteID As Integer = 0

    Private Property OldContractSiteID() As Integer
        Get
...
#Region "Events"
    ...
    Private Sub FRMContractSite_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LoadMe(sender, e)
    End Sub
