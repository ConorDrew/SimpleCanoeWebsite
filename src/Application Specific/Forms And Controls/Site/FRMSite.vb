Public Class FRMSite : Inherits FSM.FRMBaseForm : Implements IForm
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.pnlMain.Size = New System.Drawing.Size(1076, 670)
        ...
        Me.MinimumSize = New System.Drawing.Size(1100, 733)
        Me.Name = "FRMSite"
...
#Region "Interface Methods"
    ...
    Private Sub LoadMe(ByVal sender As Object, ByVal e As System.EventArgs) Implements IForm.LoadMe
        ...
        CType(LoadedControl, UCSite).CurrentSite = DB.Sites.Get(ID)
        LoadForm(sender, e, Me)

        CType(LoadedControl, UCSite).SetupContactDataGrid()
        CType(LoadedControl, UCSite).SetupInvoiceAddressDataGrid()
        CType(LoadedControl, UCSite).SetupJobsDataGrid()
        CType(LoadedControl, UCSite).SetupContractsDataGrid()
        CType(LoadedControl, UCSite).SetupSiteFuelDataGrid()
        CType(LoadedControl, UCSite).SetupSiteAuthorityAuditDataGrid()

        Try
            CType(LoadedControl, UCSite).FromForm = GetParameter(1)
