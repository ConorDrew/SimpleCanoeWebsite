Public Class UCSearchFleetVan : Inherits FSM.UCBase : Implements ISearchControl
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.txtCriteria.Size = New System.Drawing.Size(98, 21)
        ...
        Me.btnFind.Location = New System.Drawing.Point(112, 64)
...
#Region "Interface Object"
    ...
    Private Sub LoadForm(ByVal sender As Object, ByVal e As System.EventArgs) _
        Implements ISearchControl.LoadForm
        LoadBaseControl(Me)

        Combo.SetUpCombo(Me.cboSearchFor, DynamicDataTables.Setup_Search_Options(
                         Entity.Sys.Enums.MenuTypes.FleetVan), "ValueMember", "DisplayMember",
                         Entity.Sys.Enums.ComboValues.Please_Select)
        Combo.SetSelectedComboItem_By_Value(cboSearchFor, CInt(Entity.Sys.Enums.TableNames.tblFleetVan))
        txtCriteria.Focus()
    End Sub

    Private Sub Search() Implements ISearchControl.Search
        If Combo.GetSelectedItemValue(Me.cboSearchFor) = "0" Then
            ShowMessage("Please select what you would like to search for.",
        ...
        Select Case Combo.GetSelectedItemValue(Me.cboSearchFor)
            Case Entity.Sys.Enums.TableNames.tblFleetVan
                MainForm.SetSearchResults(DB.FleetVan.Search(Me.txtCriteria.Text.Trim),
                                          Entity.Sys.Enums.PageViewing.FleetVan, False, False)
            Case Entity.Sys.Enums.TableNames.tblFleetVanType
                MainForm.SetSearchResults(DB.FleetVanType.Search(Me.txtCriteria.Text.Trim),
                                          Entity.Sys.Enums.PageViewing.FleetVanType, False, False)
            Case Entity.Sys.Enums.TableNames.tblFleetEquipment
                MainForm.SetSearchResults(DB.FleetEquipment.Search(Me.txtCriteria.Text.Trim),
                                          Entity.Sys.Enums.PageViewing.FleetEquipment, False, False)
            Case Entity.Sys.Enums.TableNames.tblFleetGarage
                Dim dv As DataView = DB.Sites.Search_FleetGarage(Me.txtCriteria.Text.Trim, loggedInUser.UserID)
...
#Region "Events"
    ...
    Private Sub UCSearchPerformanceSetup_Load(ByVal sender As Object, ByVal e As System.EventArgs) _
        Handles MyBase.Load
        LoadForm(sender, e)
    End Sub
    ...
    Private Sub txtCriteria_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) _
        Handles txtCriteria.KeyUp
