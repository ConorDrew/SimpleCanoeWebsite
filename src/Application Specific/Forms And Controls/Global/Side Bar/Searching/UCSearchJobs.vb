Public Class UCSearchJobs : Inherits FSM.UCBase : Implements ISearchControl
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.txtCriteria.Size = New System.Drawing.Size(103, 21)
        ...
        Me.btnFind.Location = New System.Drawing.Point(117, 64)
        Me.btnFind.Name = "btnFind"
        Me.btnFind.Size = New System.Drawing.Size(43, 23)
...
#Region "Interface Object"
    ...
    Private Sub LoadForm(ByVal sender As Object, ByVal e As System.EventArgs) Implements ISearchControl.LoadForm
        ...
        Combo.SetUpCombo(Me.cboSearchFor, DynamicDataTables.Setup_Search_Options(Entity.Sys.Enums.MenuTypes.Jobs), "ValueMember", "DisplayMember", Entity.Sys.Enums.ComboValues.Please_Select)
    End Sub
    ...
    Private Sub Search() Implements ISearchControl.Search
        ...
        Select Case Combo.GetSelectedItemValue(Me.cboSearchFor)
            Case Entity.Sys.Enums.TableNames.tblEngineerVisit
                ShowForm(GetType(FRMVisitManager), False, New Object() {DB.EngineerVisits.EngineerVisits_Search(Me.txtCriteria.Text.Trim)})
            Case Entity.Sys.Enums.TableNames.tblQuotes
                ShowForm(GetType(FRMQuoteManager), False, New Object() {DB.Quotes.Quotes_Search(Me.txtCriteria.Text.Trim)})
        End Select
    End Sub
