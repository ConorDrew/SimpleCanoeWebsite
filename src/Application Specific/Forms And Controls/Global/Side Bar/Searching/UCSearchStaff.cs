...
namespace FSM
{
    public class UCSearchStaff : UCBase, ISearchControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            _txtCriteria.Size = new Size(105, 21);
            ...
            _btnFind.Location = new Point(119, 64);
            _btnFind.Name = "btnFind";
            _btnFind.Size = new Size(41, 23);
            _btnFind.TabIndex = 3;
            _btnFind.Text = "Find";
        ...
        private void LoadForm(object sender, EventArgs e)
        {
            ...
            Combo.SetUpCombo(ref argc, DynamicDataTables.Setup_Search_Options(Entity.Sys.Enums.MenuTypes.Staff), "ValueMember", "DisplayMember", Entity.Sys.Enums.ComboValues.Please_Select);
        }
        ...
        private void Search()
        {
            ...
            switch (switchExpr)
            {
                case var @case when @case == Conversions.ToString(Entity.Sys.Enums.TableNames.tblEngineer):
                    {
                        App.MainForm.SetSearchResults(App.DB.Engineer.Engineer_Search(txtCriteria.Text.Trim()), Entity.Sys.Enums.PageViewing.Engineer, false, false);
                        break;
                    }

                case var case1 when case1 == Conversions.ToString(Entity.Sys.Enums.TableNames.tblVan):
                    {
                        App.MainForm.SetSearchResults(App.DB.Van.Van_Search(txtCriteria.Text.Trim()), Entity.Sys.Enums.PageViewing.Van, false, false);
                        break;
                    }

                case var case2 when case2 == Conversions.ToString(Entity.Sys.Enums.TableNames.tblSubcontractor):
                    {
                        App.MainForm.SetSearchResults(App.DB.SubContractor.Subcontractor_Search(txtCriteria.Text.Trim()), Entity.Sys.Enums.PageViewing.Subcontractor, false, false);
                        break;
                    }

                case var case3 when case3 == Conversions.ToString(Entity.Sys.Enums.TableNames.tblUser):
                    {
                        App.ShowForm(typeof(FRMUsers), false, new object[] { txtCriteria.Text.Trim() });
                        break;
                    }

                case var case4 when case4 == Conversions.ToString(Entity.Sys.Enums.TableNames.tblEquipment):
                    {
                        App.MainForm.SetSearchResults(App.DB.Engineer.Equipment_Search(txtCriteria.Text.Trim()), Entity.Sys.Enums.PageViewing.Equipment, false, false);
                        break;
                    }
            }
        }
