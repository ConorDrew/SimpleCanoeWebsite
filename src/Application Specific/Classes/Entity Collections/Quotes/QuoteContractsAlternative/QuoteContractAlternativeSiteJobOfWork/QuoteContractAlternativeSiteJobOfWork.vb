...
#Region "QuoteContractAlternativeSiteJobOfWork Properties"
            ...
            Private _ScheduledOfRates_UsedForConvertOnly As DataView
            'THIS IS A STUPID WORK AROUND ONLY USED IN THE CONVERTION -AMY
            Public Property ScheduledOfRates_UsedForConvertOnly() As DataView
                Get
                    Return _ScheduledOfRates_UsedForConvertOnly
                End Get
                Set(ByVal Value As DataView)
                    _ScheduledOfRates_UsedForConvertOnly = Value
                End Set
            End Property
