...
#Region "PartSupplierPriceRequest Properties"

      
Private _PartSupplierPriceRequestID As Integer = 0
Public Readonly Property PartSupplierPriceRequestID() As Integer
	Get 
		Return _PartSupplierPriceRequestID
	End Get	
End Property	
Public Writeonly Property SetPartSupplierPriceRequestID() As Object
	Set(Value as Object)
		_dataTypeValidator.SetValue(Me, "_PartSupplierPriceRequestID", Value)
	End Set
End Property
