...
#Region "SystemScheduleOfRate Properties"


            Private _SystemScheduleOfRateID As Integer = 0
            Public ReadOnly Property SystemScheduleOfRateID() As Integer
                Get
                    Return _SystemScheduleOfRateID
                End Get
            End Property
            Public WriteOnly Property SetSystemScheduleOfRateID() As Object
                Set(ByVal Value As Object)
                    _dataTypeValidator.SetValue(Me, "_SystemScheduleOfRateID", Value)
                End Set
            End Property
