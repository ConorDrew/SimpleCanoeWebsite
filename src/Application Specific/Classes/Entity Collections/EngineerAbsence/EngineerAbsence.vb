...
#Region "EngineerAbsence Properties"

        Private _EngineerAbsenceID As Integer = 0
        Public ReadOnly Property EngineerAbsenceID() As Integer
            Get
                Return _EngineerAbsenceID
            End Get
        End Property
        Public WriteOnly Property SetEngineerAbsenceID() As Object
            Set(ByVal Value As Object)
                _dataTypeValidator.SetValue(Me, "_EngineerAbsenceID", Value)
            End Set
        End Property

        Private _EngineerID As String = String.Empty
        Public ReadOnly Property EngineerID() As String
            Get
                Return _EngineerID
            End Get
        End Property
