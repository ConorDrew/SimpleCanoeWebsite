Namespace Entity
    ...
    Namespace ContractsOriginal
        ...
        Public Class ContractOriginalValidator
            'make sure that contact object is valid
            Inherits BaseValidator

            Public Sub Validate(ByVal oContract As ContractOriginal)
                ...
                If oContract.ContractTypeID = 0 Then
                ...
                If oContract.ContractStatusID = Entity.Sys.Enums.ContractStatus.Cancelled Then
                    If oContract.ReasonID = 0 Then
